...
- [x] Sous-menus dans la barre de navigation — _Encyclopédie → les 5 catégories et le glossaire, Histoire → les jeux résumés, Soluces → les jeux dont le guide est ouvert ; au survol et au clavier sur ordinateur (aria-expanded, Échap), sous-liste dépliée dans le menu mobile_
...
- [x] Soluce Kingdom Hearts (Final Mix) — _les 15 sections du cheminement et 15 pages annexes : 99 dalmatiens, marques Trio, Forêt des Rêves Bleus, trophées, cartes postales, atelier des Mogs, ennemis spéciaux, tournois du Colisée, rapports d'Ansem, surf de la jungle, boss optionnels, fins secrètes, et trois pages de référence (invocations, inventaire, bestiaire). 78 visuels cliquables (visionneuse plein écran), tous détourés sur leur canal alpha, pris dans Kingdom Hearts et non dans les épisodes suivants. L'inventaire couvre les cinq catégories — 42 armes des trois personnages, 13 objets, les objets clés, 39 accessoires et les familles de blocs Gummi — en volets dépliants, pour qu'une page de référence reste parcourable. Le bestiaire présente 39 espèces en fiches cliquables avec leurs caractéristiques (vie, attaque, défense, expérience, début de partie et après la Forteresse Oubliée), relevées sur KHDestiny et complétées au Kingdom Hearts Wiki ; six fiches d'ennemis ont été créées et les noms français officiels rétablis sur quinze autres. Le bestiaire couvre aussi les 26 boss de l'histoire et les 5 boss facultatifs, avec un tiret là où Square Enix n'a jamais publié les chiffres. « Histoire principale » et « Guides et annexes » sont des volets dépliants ; la section « Ce que demande le 100 % » a été retirée. Détourage corrigé sur 69 visuels : le redimensionnement se fait désormais en alpha prémultiplié, après avoir étalé la couleur des pixels visibles dans la zone transparente (scratchpad/decode3.py) — sans quoi le noir des pixels invisibles déteignait sur les bords et laissait un halo sale. Les rendus pris dans un épisode ultérieur ont été remplacés par ceux de Kingdom Hearts partout où le wiki en propose un_
- [~] Soluce Kingdom Hearts II (Final Mix) — _**les 28 sections du cheminement et les 16 guides et annexes sont rédigés.** Le cheminement va du prologue à Illusiopolis : les six jours de Roxas, le premier tour de mondes, le retour à la Cité du Crépuscule et Space Paranoids, le second tour, puis la troisième Cité du Crépuscule et Illusiopolis avec ses six encadrés de boss. Les seize annexes : Atlantica (cinq actes chantés), Forêt des Rêves Bleus (cinq pages, cinq mini-jeux, vingt coffres), les coupes du Colisée (quatre coupes et leurs quatre Paradoxe, jusqu'aux cinquante manches de la Coupe Hadès), les formes de Fusion (six formes, paliers d'expérience chiffrés, capacités de croissance), les invocations (quatre pendentifs, tableau des niveaux), la synthèse (quatorze familles de matériaux, neuf niveaux du Mog, seize formules, les treize Orichalque + de l'Ultima), les mini-jeux et missions (vingt-trois épreuves), les puzzles (six puzzles, 144 pièces par monde), les Bolets XIII (treize défis chronométrés), les Silhouettes Spectrales et les treize Répliques de l'Organisation, les boss facultatifs (Séphiroth, la Volonté Persistante, la Caverne du Souvenir), les treize rapports d'Ansem, l'inventaire (Keyblades, armes des compagnons, armures, accessoires, objets-clés), le bestiaire (fiches cliquables plus le relevé complet des Sans-cœur, des Similis et des exclusivités Final Mix), les 51 trophées avec leurs noms français officiels, et les fins secrètes avec leurs conditions par difficulté. Correction générale : les cellules des tableaux, le tableau des récompenses, les attaques et les récompenses des encadrés de boss et les listes de ramassage passent maintenant par RichText — le gras et les liens vers l'encyclopédie y restaient en texte brut, sur KH II comme sur KH I. **Les 28 chapitres sont illustrés** : 56 captures de Kingdom Hearts II reprises du Kingdom Hearts Wiki, réduites en webp 480 px, réparties dans les étapes des sections (une à trois par chapitre) et dans six pages d'annexes. Le wiki étant injoignable depuis le conteneur (proxy) comme depuis le shell de la machine (montage Windows cassé depuis le 8 septembre), les images ont été récupérées via le navigateur d'Adam, empaquetées dans une archive tar construite en JavaScript, découpée en huit morceaux pour passer le pont de fichiers, puis réassemblée et convertie côté conteneur_
- [ ] Réconcilier les noms français des ennemis de Kingdom Hearts II — _Les noms employés par KHDestiny (Androïde, Carapçon, Roto-tank, Chimère, Funambule, Sombreur…) ne correspondent pas à ceux de l'encyclopédie, qui garde souvent le nom anglais faute de traduction officielle vérifiée. Les correspondances n'ont pas été devinées : les fiches cliquables du bestiaire de KH II ne couvrent donc que les espèces dont le nom est certain des deux côtés, et les tableaux complets gardent les noms de KHDestiny. À traiter dans un lot dédié : établir la correspondance français ↔ anglais espèce par espèce, puis rétablir les noms français officiels dans l'encyclopédie et compléter les fiches du bestiaire_
- [~] Soluce Kingdom Hearts III + Re Mind — _**Les 14 sections du cheminement sont rédigées**, du Palier de l'Éveil à Scala ad Caelum : le prologue et ses deux choix définitifs, Olympe et les six systèmes qu'il débloque, la Cité du Crépuscule (bistrot, boutique Gummi, Royaume Classique), le Coffre à Jouets et ses Gigas, le Royaume de Corona et les quatre moments de Raiponce, Monstropolis et ses Nescients, Arendelle et sa grotte de glace, Les Caraïbes et la navigation, San Fransokyo, puis la fin en cinq chapitres — le Monde obscur et la Contrée du Départ, la Nécropole des Keyblades, le Monde Final, le retour à la Nécropole pour les six combats de l'Organisation, et Scala ad Caelum. Trente-deux encadrés de combat, les objets manquables signalés monde par monde. **24 captures de Kingdom Hearts II et III** illustrent les chapitres, plus trois rendus des Titans détourés en alpha prémultiplié. **Les 8 premières annexes sur 16 sont rédigées** : les emblèmes fétiches (90 emblèmes, les 17 paliers de récompense, les seuils de la scène secrète par difficulté), la Forêt des Rêves Bleus (les trois épreuves et la Keyblade Verse-miel), les portails de combat (les quinze portails avec lieu, difficulté et récompense, plus l'encadré d'Obscurantis), les Sept Flantastiques (lieu, score et compétence de chaque flan), le Bistrot du Petit Chef (les 28 recettes en six tableaux, ingrédients et bonus normal/+), l'atelier des Mogs (les quatre services, les sept sources d'Orichalque +, les familles de matériaux, l'Ultima Arma), les formes de Keyblade (les dix formes et les armes qui les portent) et le Royaume Classique (les 23 mini-jeux et leur emplacement). **Les 8 dernières annexes sont rédigées** : les figurines dorées d'Hercule (les cinq emplacements de Thèbes et la Ceinture de héros), les mini-jeux (Verum Rex, Danse festive, Luge alpine et son Orichalque +, Lumirallye, plus la navigation des Caraïbes), le vaisseau Gummi (les trois espaces Starlight Way, Misty Stream et The Eclipse, neuf sphères au trésor, neuf constellations, les affrontements géants dont le Schwarzgeist à 200 de vitesse et l'Omega Machina), les 13 rapports secrets avec leur auteur et leur titre, l'inventaire (les 14 Keyblades avec Force, Magie et obtention, les armes de Donald et de Dingo, les six familles d'accessoires, les objets-clés), le bestiaire (42 Sans-cœur avec leurs mondes et leurs matériaux, les 4 Nescients de Monstropolis, et la note sur l'absence de Similis communs), les 46 trophées en cinq tableaux sans volet dépliant, et la scène secrète (les seuils par difficulté, Critique compris). **Les 16 annexes de Kingdom Hearts III sont donc terminées** ; restent les captures dans les pages d'annexes. L'extension **Re Mind** fera l'objet d'un guide à part_
