...
export const moreKeyblades: KeybladeEntry[] = [
  ...
  },
  {
    ...
    description: L(
      "Ajoutée dans Kingdom Hearts II Final Mix, Treize Fongus est le trophée ultime des Champignons XIII, les treize Sans-cœur casse-tête dispersés dans les mondes : il faut obtenir leur emblème dans chaque défi. Sa lame rose et blanche reprend leurs couleurs et leur signe.\n\nSes statistiques élevées s'accompagnent de Zéro Expérience, ce qui la destine aux joueurs souhaitant relever des défis à bas niveau.",
  ...
  },
  {
    ...
    description: L(
      "Bleue et métallique, Hyperdrive reproduit l'esthétique du vaisseau de la Fédération Galactique de Lilo & Stitch, avec un porte-clés en forme de Stitch. Elle est obtenue à la fin du monde de l'Espace Profond dans Birth by Sleep.\n\nÉquilibrée, elle sert de bonne arme de milieu d'aventure aux trois protagonistes.",
    ...
    obtained: { "birth-by-sleep": L("Espace Profond, à la fin du scénario de chaque personnage.", "Deep Space, at the end of each character's episode.") },
    appearances: ["birth-by-sleep"],
    debut: "birth-by-sleep",
    tags: ["stitch", "espace"],
  },
  ...
  },
  {
    ...
    description: L(
      "Faite de portées, de notes et d'une clé de sol, Counterpoint est la Keyblade de la Symphonie du Sorcier, le monde inspiré de Fantasia. Sora et Riku l'obtiennent après avoir vaincu le Cauchemar qui menace Yen Sid apprenti.\n\nElle possède le meilleur bonus de magie des Keyblades de monde de Dream Drop Distance.",
    ...
    obtained: { "dream-drop-distance": L("Symphonie du Sorcier, à la fin du monde.", "Symphony of Sorcery, at the end of the world.") },
    appearances: ["dream-drop-distance"],
    debut: "dream-drop-distance",
