 ...
 * puissance d'attaque, Chain of Memories des notes de carte, Kingdom Hearts III fait évoluer
 * la lame du niveau 0 au niveau 10 (d'où les fourchettes « +4 → +9 »).
...
export const keybladeStats: Record<string, KeybladeGameStat[]> = {
  ...
  "all-for-one": [
    { game: "dream-drop-distance", strength: "+10", magic: "+12", reach: "98" },
  ],
  "astral-blast": [
  ...
  "brightcrest": [
    { game: "birth-by-sleep", strength: "+4", magic: "+7", reach: "113" },
  ],
  "chaos-ripper": [
    { game: "birth-by-sleep", strength: "+10", magic: "-2", reach: "150" },
  ],
  "circle-of-life": [
  ...
  "counterpoint": [
    { game: "dream-drop-distance", strength: "+12", magic: "+14", reach: "113" },
  ],
  "crabclaw": [
  ...
  "darkgnaw": [
    { game: "birth-by-sleep", strength: "+5", magic: "+2", reach: "98" },
  ],
  "dawn-till-dusk": [
  ...
  "destinys-embrace": [
    { game: "birth-by-sleep", strength: "+3", magic: "+3", reach: "85" },
  ],
  "diamond-dust": [
  ...
  "divewing": [
    { game: "dream-drop-distance", strength: "+12", magic: "+15", reach: "113" },
  ],
  "divine-rose": [
  ...
  "dual-disc": [
    { game: "dream-drop-distance", strength: "+10", magic: "+7", reach: "98" },
  ],
  "earthshaker": [
    { game: "birth-by-sleep", strength: "+3", magic: "+1", reach: "98" },
  ],
  "elemental-encoder": [
    { game: "kingdom-hearts-iii", strength: "+4 → +9", magic: "+4 → +9", abilities: ["Lucky Strike", "Magic Roulette", "Formchange Extender"] },
  ],
  "end-of-pain": [
    { game: "dream-drop-distance", strength: "+14", magic: "+16", reach: "113" },
  ],
  "ends-of-the-earth": [
    { game: "birth-by-sleep", strength: "+5", magic: "+3", reach: "130" },
  ],
  "ever-after": [
  ...
  "fairy-stars": [
    { game: "birth-by-sleep", strength: "+2", magic: "+3" },
  ],
  "fatal-crest": [
  ...
  "ferris-gear": [
    { game: "dream-drop-distance", strength: "+8", magic: "+8", reach: "85" },
  ],
  "follow-the-wind": [
  ...
  "guardian-bell": [
    { game: "dream-drop-distance", strength: "+7", magic: "+10", reach: "98" },
  ],
  "guardian-soul": [
  ...
  "hyperdrive": [
    { game: "birth-by-sleep", strength: "+4", magic: "+3" },
  ],
  "jungle-king": [
  ...
  "kingdom-key": [
    ...
    { game: "dream-drop-distance", strength: "5", magic: "4", reach: "75" },
  ...
  "knockout-punch": [
    { game: "dream-drop-distance", strength: "12", magic: "10", reach: "113" },
  ],
  "lady-luck": [
  ...
  "lost-memory": [
    { game: "birth-by-sleep", strength: "+6", magic: "+5", reach: "98" },
  ],
  "lunar-eclipse": [
    { game: "358-2-days", strength: "+100", magic: "+31", abilities: ["Striker", "Grand Slam", "Damage Control"] },
  ],
  "mark-of-a-hero": [
    { game: "birth-by-sleep", strength: "+5", magic: "+1" },
  ],
  "master-keeper": [
    { game: "birth-by-sleep", strength: "+7", magic: "+7", reach: "long" },
  ],
  "masters-defender": [
    { game: "birth-by-sleep", strength: "+7", magic: "+7", reach: "long" },
  ],
  ...
  "pixie-petal": [
    { game: "birth-by-sleep", strength: "+3", magic: "+6" },
  ],
  "pumpkinhead": [
  ...
  "rainfell": [
    { game: "birth-by-sleep", strength: "+2", magic: "+2", reach: "75" },
  ],
  "rejection-of-fate": [
    { game: "358-2-days", strength: "+52", magic: "+0", abilities: ["Offensive Block", "Defender", "Second Chance"] },
  ],
  "royal-radiance": [
    { game: "birth-by-sleep", strength: "+8", magic: "+7", reach: "long" },
  ],
  "rumbling-rose": [
  ...
  "skull-noise": [
    { game: "dream-drop-distance", strength: "+7", magic: "+7", reach: "85" },
  ],
  "sleeping-lion": [
  ...
  "stormfall": [
    { game: "birth-by-sleep", strength: "+5", magic: "+4", reach: "98" },
  ],
  "stroke-of-midnight": [
    { game: "birth-by-sleep", strength: "+2", magic: "+2" },
  ],
  "sweet-dreams": [
    { game: "dream-drop-distance", strength: "+14", magic: "+12", reach: "113" },
  ],
  "sweet-memories": [
    { game: "kingdom-hearts-ii", reach: "102", abilities: ["Lucky Lucky", "Drive Converter"] },
  ],
  "sweetstack": [
    { game: "birth-by-sleep", strength: "+6", magic: "+4" },
  ],
  "three-wishes": [
  ...
  "treasure-trove": [
    { game: "birth-by-sleep", strength: "+3", magic: "+2" },
  ],
  "true-lights-flight": [
  ...
  "ultima-weapon": [
    ...
    { game: "birth-by-sleep", strength: "+7", magic: "+6" },
    { game: "re-coded", reach: "very-long", abilities: ["Heavy Blade", "Brick Wall", "Protect", "Undo"] },
    { game: "dream-drop-distance", strength: "16", magic: "16", reach: "113" },
  ...
  "unbound": [
    { game: "dream-drop-distance", strength: "+18", magic: "+14", reach: "113" },
  ],
  "victory-line": [
    { game: "birth-by-sleep", strength: "+4", magic: "+2" },
  ],
  "void-gear": [
    { game: "birth-by-sleep", strength: "+8", magic: "+4", reach: "long" },
  ],
  "way-to-the-dawn": [
    { game: "kingdom-hearts-ii", strength: "+3" },
    { game: "358-2-days", strength: "+124", magic: "+30", abilities: ["Vitality Surge", "Vitality Barrier", "Alive 'n' Kicking"] },
    { game: "dream-drop-distance", strength: "5", magic: "4", reach: "85" },
  ],
  "wayward-wind": [
    { game: "birth-by-sleep", strength: "+3", magic: "+1", reach: "65" },
  ],
  "wheel-of-fate": [
