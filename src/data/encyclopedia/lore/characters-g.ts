  ...
  "daisy": {
    sections: [
      ...
      },
      {
        game: "birth-by-sleep",
        text: L(
          "Une dizaine d'années avant l'aventure de Sora, Daisy vit à la Ville Disney, la bourgade voisine du château. Elle y participe aux préparatifs du Festival des Rêves, la fête organisée par la reine Minnie, et croise Terra, Ventus et Aqua lors de leurs passages.\n\nLe festival est perturbé par Pat Hibulaire, qui truque les épreuves et convoite le prix. Daisy fait partie des habitants floués par ses manœuvres, et c'est aux trois porteurs de Keyblade que revient de rétablir l'honnêteté des jeux. Cette apparition, purement domestique, sert surtout à montrer la Ville Disney en temps de paix, avant que les ténèbres n'atteignent le royaume.",
  ...
  "horace-horsecollar": {
    sections: [
      ...
      },
      {
        game: "birth-by-sleep",
        text: L(
          "Horace n'apparaît que dans Birth by Sleep, lors des visites de Terra, Ventus et Aqua à la Ville Disney. La ville est alors en pleine effervescence : la reine Minnie a lancé le Festival des Rêves, une fête faite de courses, de jeux de plateau et de concours de glaces.\n\nHorace fait partie des habitants qui animent ces réjouissances et accueillent les trois porteurs, à qui Minnie remet une médaille en récompense de leur participation. Il assiste ainsi, sans le savoir, aux manigances de Pat Hibulaire, qui triche pour remporter le prix du festival avant d'être démasqué. Aucun combat ne se déroule en sa présence : la Ville Disney reste, dans tout l'épisode, l'un des rares mondes épargnés par les Nescients.",
  ...
  "pegasus": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-ii",
        text: L(
          "Pégase n'apparaît que brièvement dans Kingdom Hearts II, dans les scènes du Colisée. On le voit emporter Hercule et Mégara lorsque le héros s'échappe de la foule de ses admirateurs, image reprise du film.\n\nSon rôle reste strictement décoratif : le monde se joue alors au sol, dans les arènes du Colisée et du Colisée des Ombres, et aucune séquence de vol n'est proposée au joueur. Sa présence sert surtout à rappeler l'existence d'un Olympe plus vaste que l'arène, que le jeu suivant finira par montrer réellement.",
