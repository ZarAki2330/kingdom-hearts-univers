...
export const lore: Record<string, EntryLore> = {
  ...
  "jungle-king": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts",
        text: L(
          "Sora reçoit Roi de la Jungle à la Jungle Profonde, une fois Clayton démasqué et vaincu au campement, et la serrure du monde scellée dans l'arbre creux où Tarzan conduit le groupe. Elle arrive donc tôt dans l'aventure, juste après la Ville de Traverse et le Pays des Merveilles.\n\nSur le terrain, c'est une arme de force pure : elle n'apporte aucun bonus de magie, mais sa portée allongée permet de toucher les Sans-cœur avant qu'ils n'atteignent Sora, ce qui est précieux contre les Ombres et les Soldats en nombre. Elle sert surtout de transition, le temps d'atteindre Agrabah et Trois Souhaits, mais reste appréciée des joueurs qui privilégient les combos au corps à corps.",
  ...
  "crabclaw": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts",
        text: L(
          "Ariel remet Pince de Crabe à Sora à Atlantica, une fois Ursula vaincue dans les ruines englouties et la serrure du monde scellée sous la grotte secrète de la sirène. Le monde étant facultatif au sens strict de la progression, certains joueurs la découvrent tardivement.\n\nContrairement aux Keyblades précédentes, elle penche du côté de la magie : son bonus de MP en fait l'un des meilleurs choix du milieu de jeu pour enchaîner Glace et Soin, notamment pendant les combats aquatiques où la nage rend les combos moins fiables. Elle reste un compromis très correct jusqu'à l'obtention d'Ensorceleuse chez Merlin. Elle revient en carte dans Chain of Memories, liée au souvenir d'Atlantica.",
  ...
  "pumpkinhead": {
    ...
    trivia: [L("Tête de Citrouille et Citrouille Décisive portent le même nom japonais, パンプキンヘッド (Pumpkinhead).", "Pumpkinhead and Decisive Pumpkin share the same Japanese name, パンプキンヘッド (Pumpkinhead).")],
    ...
    sections: [
      {
        title: L("Apparence et symbolique", "Design and symbolism"),
        text: L(
          "Harpe des Fées est bâtie comme un instrument de musique : la lame verte s'incurve en arc de harpe, la garde imite le cadre doré de l'instrument, et les dents dessinent une aile stylisée. Les teintes vertes et or reprennent celles de la tunique de Peter Pan et de la poussière de fée qui permet de voler.\n\nSon porte-clés est une petite fée, en référence évidente à Clochette, qui accompagne Sora comme invocation dans le premier jeu. Toute l'arme parle du Pays Imaginaire : le vol, l'enfance qui refuse de finir, et la musique légère des scènes où le navire du Capitaine Crochet flotte au-dessus de Londres.",
  ...
  "wishing-star": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts",
        text: L(
          "Contrairement aux autres porte-clés de mondes, Étoile du Berger ne s'obtient pas dans Monstro mais à la Ville de Traverse : une fois la baleine quittée, Geppetto et Pinocchio s'installent dans le quartier d'accès, et parler au vieil artisan chez lui donne la Keyblade.\n\nEn combat, elle est modeste : sa force et sa magie restent inférieures à celles de Trois Souhaits, et elle sert surtout de récompense de collection. Sa véritable valeur est ailleurs : la maison de Geppetto abrite aussi l'atelier de synthèse des Mogs, et la visite qui offre la Keyblade est l'occasion de découvrir Cid, les objets rares et la chaîne d'améliorations qui mène à l'Arme Ultime.",
  ...
  "spellbinder": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts",
        text: L(
          "Ensorceleuse ne se trouve pas dans un coffre : elle est offerte par Merlin, à la Ville de Traverse, lorsque Sora vient lui montrer qu'il maîtrise les trois magies élémentaires de base — Brasier, Glacier et Foudre — apprises auprès des différents mondes et alliés.\n\nC'est de loin la meilleure Keyblade magique de la première moitié du jeu : son bonus de MP dépasse celui de Harpe des Fées, au prix d'une force très faible. Elle transforme la manière de jouer, en poussant à alterner sorts et coups plutôt qu'à enchaîner les combos, et reste pertinente jusqu'aux Keyblades de la Forteresse Oubliée. Elle prépare aussi la visite de la Forêt des Rêves Bleus, dont Merlin garde le livre.",
  ...
  "lady-luck": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts",
        text: L(
          "Bonne Fortune n'est pas remise par un personnage : elle attend dans un coffre de la Forêt des Lotus, au Pays des Merveilles, accessible seulement en déclenchant une Trinité — les marques au sol que Sora, Donald et Dingo activent ensemble. Il faut donc revenir dans le monde plus tard, une fois la capacité obtenue.\n\nSes statistiques sont équilibrées, avec un peu de force et un peu de magie, ce qui en fait une alternative honnête à Trois Souhaits pour un joueur qui alterne coups et sorts. Elle vaut surtout comme récompense d'exploration : sa présence rappelle que les Trinités cachent, dans presque chaque monde, un coffre que la progression normale laisse de côté.",
  ...
  "lionheart": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts",
        text: L(
          "Cœur de Lion est l'une des récompenses les plus exigeantes du jeu : elle s'obtient au Colisée de l'Olympe en franchissant la Coupe Hadès, le tournoi de haut niveau qui n'est ouvert qu'après les trois premières coupes, et qui oppose notamment Sora à Léon et Cloud réunis dans le même combat.\n\nStatistiquement, c'est une Keyblade équilibrée et très solide, à la fois en force et en magie, souvent considérée comme la meilleure arme polyvalente avant la Rose Divine et l'Arme Ultime. Elle est aussi une déclaration d'intention de la série : intégrer les héros de Final Fantasy à l'univers Disney, non comme des clins d'œil, mais comme des adversaires qu'il faut battre pour progresser.",
  ...
  "metal-chocobo": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts",
        text: L(
          "Sora reçoit Chocobo de Métal au Colisée de l'Olympe, en remportant la Coupe Hercule, la troisième du tournoi, dont Cloud est l'un des adversaires : le mercenaire, lié par un pacte à Hadès, y affronte Sora avant de se retourner contre le dieu des Enfers.\n\nC'est une arme de force pure, avec une allonge exceptionnelle qui permet de balayer plusieurs Sans-cœur d'un seul coup, mais un malus notable sur les MP : équiper Chocobo de Métal, c'est renoncer aux sorts. Elle convient aux joueurs qui misent tout sur les combos et sur les capacités physiques, et reste un choix populaire pour affronter les boss du Bout du Monde.",
  ...
  "one-winged-angel": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts",
        text: L(
          "Ange à une Aile est exclusive à Kingdom Hearts Final Mix, la réédition japonaise du premier jeu, reprise ensuite dans les collections HD. On l'obtient au Colisée de l'Olympe en battant Sephiroth, adversaire optionnel réputé pour être le combat le plus dur du jeu, bien au-delà du niveau requis par l'histoire.\n\nEn récompense, elle offre le meilleur bonus de force du jeu, assorti d'un malus sur les MP et d'un effet particulier : elle draine des PV à chaque coup porté, ce qui la rend redoutable en combat prolongé. Elle est la Keyblade des joueurs qui ont épuisé le contenu principal, symbole de fin de parcours au même titre que l'Arme Ultime.",
    ...
    sections: [
      {
        title: L("Apparence et symbolique", "Design and symbolism"),
        text: L(
          "Poussière de Diamant est taillée dans la glace : la lame est un long cristal bleu pâle, translucide, dont les dents forment un flocon, et la garde s'ouvre en éclats gelés. C'est l'une des rares Keyblades du premier jeu à n'avoir ni métal ni bois dans sa composition apparente.\n\nSon nom est celui de l'attaque signature de Shiva, l'invocation de glace récurrente de la série Final Fantasy, et son porte-clés est un flocon de neige. Elle célèbre donc, comme Ange à une Aile, l'héritage Square plutôt qu'un monde Disney, et se rattache au Titan de Glace, l'un des colosses que Sora doit affronter dans l'arène du Colisée de l'Olympe.",
  ...
  "heros-crest": {
    sections: [
      ...
      },
      {
        ...
        text: L(
          "Phil et Hercule remettent Gage du Héros à Sora lors de la première visite du Colisée de l'Olympe, après la remontée du Val des Morts et surtout après l'affrontement contre l'Hydre dans l'arène, l'un des premiers grands combats du jeu.\n\nSa capacité est Combo aérien +, qui allonge les enchaînements de Sora dans les airs. C'est une orientation force, pensée pour les joueurs qui gardent leurs adversaires en l'air, et elle reste efficace pendant tout le premier tour des mondes. Le Colisée fournira plus tard Âme Gardienne, puis Aile Fatale et Preuve du Vainqueur pour les coupes de haut niveau : Gage du Héros est la première marche de cette progression.",
  ...
  "photon-debugger": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-ii",
        text: L(
          "Tron remet Débogueur Photon à Sora lors de la première visite de Space Paranoids, après le combat contre le Sans-cœur Hostile dans le canyon de données et la restauration d'une partie du système piraté depuis le bureau d'Ansem, au Jardin Radieux.\n\nSa capacité est Foudre +, qui renforce les dégâts de la magie Foudre — cohérent avec un monde tout entier fait d'électricité. Le porte-clés penche nettement du côté de la magie et devient l'arme de choix pour un Sora spécialisé dans Foudre, notamment contre les groupes d'ennemis. Il annonce Dual Disc, son équivalent de Dream Drop Distance, obtenu dans La Grille.",
  ...
  "rumbling-rose": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-ii",
        text: L(
          "Sora obtient Rose Grondante au Château de la Bête, lors de la seconde visite, après avoir affronté Xaldin sur le pont du château : le membre de l'Organisation XIII manipulait la Bête depuis le début pour lui arracher un cœur assez sombre et le transformer en Sans-cœur et en Simili.\n\nSa capacité est Finition +, qui autorise un coup final supplémentaire à la fin des combos — l'une des capacités les plus prisées du jeu pour maximiser les dégâts. Le porte-clés est nettement orienté force et devient, avec Citrouille Décisive, l'un des choix de référence pour la fin de Kingdom Hearts II et pour les combats de données du Final Mix.",
  ...
  "guardian-soul": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-ii",
        text: L(
          "Âme Gardienne s'obtient au Colisée de l'Olympe, lors de la seconde visite, après la descente dans le Val des Morts, la libération d'Auron de l'emprise d'Hadès et la victoire sur le dieu des morts au fond de son domaine.\n\nSa capacité est Réaction +, qui augmente les dégâts infligés par les commandes de réaction — un choix cohérent dans un jeu qui en fait un pilier de son système de combat, et particulièrement efficace contre les boss dont les phases reposent sur ces commandes. Le porte-clés est orienté force et reste un bon compromis jusqu'aux Keyblades de fin de partie, Rose Grondante et Citrouille Décisive en tête.",
    ...
    sections: [
      {
        title: L("Apparence et symbolique", "Design and symbolism"),
        text: L(
          "Dragon Caché est une Keyblade d'inspiration chinoise : sa lame verte et blanche est fine et droite comme une lame de jian, sa garde imite un pommeau de sabre orné d'un gland de soie, et ses dents dessinent une flamme stylisée. La sobriété du dessin reprend celle des paysages de la Terre des Dragons.\n\nSon porte-clés est un petit dragon enroulé, référence évidente à Mushu, le gardien de la famille Fa qui accompagne Mulan, mais aussi au titre : le « dragon caché » est Mulan elle-même, jeune femme dissimulée sous l'identité du soldat Ping pour prendre la place de son père dans l'armée impériale.",
      ...
      },
      {
        game: "kingdom-hearts-ii",
        text: L(
          "Sora obtient Dragon Caché à la Terre des Dragons, lors de la première visite, après la montée de la montagne enneigée, l'avalanche déclenchée contre les Huns et la victoire sur Shan-Yu devant le palais impérial.\n\nSa capacité est Rage de MP, qui restaure des MP lorsque Sora subit des dégâts : une orientation magie qui récompense un jeu risqué, puisqu'il faut encaisser pour relancer ses sorts. Le porte-clés est l'un des premiers du jeu à proposer un bonus de magie franc, et il reste utile jusqu'à Cercle de Vie et Débogueur Photon, obtenus dans les mondes suivants.",
    ...
    sections: [
      {
        title: L("Apparence et symbolique", "Design and symbolism"),
        text: L(
          "Aile Fatale est une Keyblade rouge et noire, agressive dans chacune de ses lignes : la lame porte des motifs de flammes, la garde forme deux ailes repliées, et les dents dessinent un blason brisé. Elle rappelle les arènes souterraines du Val des Morts plus que les colonnades de l'Olympe.\n\nSon porte-clés est un emblème de flamme, écho des feux bleus d'Hadès qui éclairent la Coupe Déesse du Destin. Comme Preuve du Vainqueur, elle ne représente pas un monde mais un exploit : celle qui l'obtient a franchi l'un des tournois les plus longs de Kingdom Hearts II, seule véritable épreuve d'endurance du jeu de base.",
  ...
  "decisive-pumpkin": {
    ...
    trivia: [L("Tête de Citrouille et Citrouille Décisive portent le même nom japonais ; seules les versions occidentales les distinguent.", "Pumpkinhead and Decisive Pumpkin share one Japanese name; only the Western releases tell them apart.")],
    ...
    sections: [
      {
        title: L("Apparence et symbolique", "Design and symbolism"),
        text: L(
          "Lion Endormi est la Keyblade la plus proche d'une arme à feu de toute la série : sa lame grise et bleue reprend la silhouette de la gunblade de Léon, avec sa poignée, sa garde carrée et son mécanisme, et les dents forment un bloc anguleux au bout du canon. Le style est industriel, sans aucun ornement.\n\nSon porte-clés est la tête de lion griffé de Griever, le symbole que Squall Leonhart porte au cou dans Final Fantasy VIII. Elle succède ainsi à Cœur de Lion du premier jeu, mais dans un contexte différent : Léon est désormais l'un des artisans de la reconstruction du Jardin Radieux, aux côtés d'Aerith, de Yuffie, de Cid et de Merlin.",
      ...
      },
      {
        game: "kingdom-hearts-ii",
        text: L(
          "Lion Endormi ne s'obtient pas en battant Léon : elle attend dans un coffre du bureau d'Ansem, au Jardin Radieux, la pièce cachée derrière la bibliothèque du château depuis laquelle on accède à l'ordinateur qui mène à Space Paranoids.\n\nSa capacité est Combo +, qui ajoute un coup aux enchaînements au sol. Le porte-clés offre des statistiques équilibrées, honorables sans être exceptionnelles, et sert surtout de valeur sûre pour la seconde moitié du jeu, en attendant Rose Grondante ou Citrouille Décisive. Son emplacement en fait aussi une récompense d'exploration : rien n'oblige à ouvrir ce coffre pour avancer dans l'histoire.",
  ...
  "treasure-trove": {
    sections: [
      ...
      },
      {
        game: "birth-by-sleep",
        text: L(
          "Treasure Trove est remise au personnage à la fin de l'épisode du Bois des Nains, quel que soit celui des trois protagonistes que l'on incarne : Terra, qui y croise la Reine et son miroir magique, Ventus, qui protège Blanche-Neige des Nescients, ou Aqua, qui affronte la sorcière dans la forêt.\n\nLe système de Birth by Sleep diffère de celui des autres épisodes : la Keyblade équipée modifie les statistiques et surtout le Style de Combat auquel elle donne accès. Treasure Trove est un porte-clés d'entrée de gamme, équilibré, dont l'intérêt est de faire découvrir le fonctionnement des commandes et des Styles avant les armes plus spécialisées des mondes suivants.",
    ...
    sections: [
      {
        title: L("Apparence et symbolique", "Design and symbolism"),
        text: L(
          "Stroke of Midnight est une Keyblade de bal : sa lame bleu pâle et argentée s'élance comme une aiguille d'horloge, sa garde forme un cadran, et ses dents reprennent la silhouette d'un escalier de château. L'ensemble est fin, presque fragile, dans les teintes de la robe de Cendrillon.\n\nSon porte-clés est une pantoufle de verre. Le nom de l'arme désigne le douzième coup de minuit, l'instant où le sortilège de la Bonne Fée se rompt et où le carrosse redevient citrouille. La Keyblade renvoie donc au Château des Rêves et à ce qui, dans Birth by Sleep, fait de Cendrillon l'exemple même d'un cœur assez fort pour espérer sans jamais céder.",
