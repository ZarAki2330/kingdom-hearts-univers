  ...
  "earthshaker": {
    sections: [
      ...
      },
      {
        ...
        text: L(
      "Gardien de la Terre est la matrice de deux Keyblades essentielles. La première est Confins de la Terre, sa forme finale, que Terra obtient au Nécropole des Keyblades et qui devient l'arme de la Volonté Persistante. La seconde est indirecte : la Keyblade de Riku, car c'est le rite accompli avec Gardien de la Terre qui fait de lui un Porteur, puis conduit la Chaîne Royale à choisir Sora à sa place.\n\nDans Kingdom Hearts III, c'est Confins de la Terre et non Gardien de la Terre que l'on voit dans les mains de l'armure de Terra ; Gardien de la Terre reste ainsi une Keyblade propre à Birth by Sleep, où elle apparaît aussi dans les tenues et données de Terra dans l'Arène des Mirages.",
  ...
  "rainfell": {
    sections: [
      ...
      },
      {
        title: L("Héritage", "Legacy"),
        text: L(
      "Pluie Enchantée disparaît du récit après Birth by Sleep. Au Nécropole des Keyblades, Aqua obtient Tempête, sa forme aboutie ; puis, dans l'Épisode Final, elle prend la Keyblade de son maître défunt, Maître Gardien, pour transformer la Contrée du Départ en Manoir Oblivion et affronter Terra-Xehanort. C'est Maître Gardien qu'elle conserve dans le Domaine des Ténèbres, dans 0.2 et dans Kingdom Hearts III.\n\nLa Keyblade bleue d'Aqua reste néanmoins essentielle à la saga : c'est elle que Kairi a touchée au Jardin Radieux, et donc l'origine indirecte de Appel du destin. Pluie Enchantée est ainsi la Keyblade par laquelle la lignée d'Eraqus atteint la nouvelle génération de Porteurs.",
