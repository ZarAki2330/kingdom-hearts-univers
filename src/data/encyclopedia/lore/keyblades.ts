  ...
  "earthshaker": {
    sections: [
      ...
      },
      {
        ...
        text: L(
      "Trembleterre est la matrice de deux Keyblades essentielles. La première est Confins de la Terre, sa forme finale, que Terra obtient au Nécropole des Keyblades et qui devient l'arme de la Volonté Persistante. La seconde est indirecte : la Keyblade de Riku, car c'est le rite accompli avec Trembleterre qui fait de lui un Porteur, puis conduit la Chaîne Royale à choisir Sora à sa place.\n\nDans Kingdom Hearts III, c'est Confins de la Terre et non Trembleterre que l'on voit dans les mains de l'armure de Terra ; Trembleterre reste ainsi une Keyblade propre à Birth by Sleep, où elle apparaît aussi dans les tenues et données de Terra dans l'Arène des Mirages.",
