...
export const lore: Record<string, EntryLore> = {
  ...
  "kingdom-key": {
    sections: [
      ...
      },
      {
        ...
        text: L(
      "Kingdom Hearts III rend enfin justice à la Chaîne Royale : Sora commence l'aventure avec elle et elle dispose d'une transformation, la Seconde Forme, qui reprend les techniques emblématiques des premiers épisodes comme Sonic Blade, Arcanum ou Ragnarok. Grâce à la forge des Mogs, elle peut être renforcée jusqu'au niveau 10 et rester compétitive jusqu'au Nécropole des Keyblades, où Sora la manie contre les treize ténèbres de la nouvelle Organisation.\n\nC'est encore elle que Sora tient face au Maître Xehanort à Scala ad Caelum, avant de recevoir la χ-blade des mains de son ennemi vaincu pour refermer Kingdom Hearts. Dans Re Mind, elle accompagne Sora lorsqu'il remonte le temps pour sauver ses amis, et elle est l'arme de Sora dans Melody of Memory, qui revisite toute la saga en musique.",
  ...
  "ultima-weapon": {
    sections: [
      {
        title: L("Origines", "Origins"),
        text: L(
      "L'Ultima est le nom donné, dans presque chaque épisode, à la Keyblade la plus puissante que Sora puisse obtenir. Le nom vient de Final Fantasy, où « Ultima Weapon » désigne à la fois une arme légendaire et un monstre redoutable. Chaque jeu lui donne un dessin différent, mais on retrouve des constantes : de l'or, du bleu ou du blanc, des ailes et une couronne, et un porte-clés qui reprend la couronne portée par Sora.\n\nElle n'a pas de porteur historique ni de place dans le récit : c'est une récompense de synthèse, fabriquée chez les Mogs à partir de matériaux rares dont l'Orichalque. Sa symbolique est celle de l'accomplissement : obtenir l'Ultima signifie avoir exploré tous les mondes et maîtrisé le système de synthèse.",
      ...
      },
      {
        game: "kingdom-hearts-iii",
        text: L(
      "Dans Kingdom Hearts III, l'Ultima se forge à l'atelier des Mogs avec sept Orichalque+, deux Cristaux Lucides, deux Cristaux Pulsants et deux Cristaux Éclatants. Les sept Orichalque+ imposent de faire le tour du jeu : réussir tous les défis des Sept Flans, collectionner toutes les Marques Chanceuses, remplir les commandes photo des Mogs, terminer la course de luge d'Arendelle, vaincre le boss gummi final, obtenir un score au Monde Final et ouvrir un coffre au Nécropole des Keyblades.\n\nAvec 13 en force et en magie, elle domine toutes les autres Keyblades, y compris celles de Re Mind. Sa transformation, la Forme Ultime, fait pleuvoir des rayons de lumière et permet d'enchaîner un finisher dévastateur, ce qui en fait un atout majeur contre les combats de données et Yozora.",
    ...
    trivia: [
      ...
      L("Birth by Sleep, Re:coded et Dream Drop Distance ont aussi leur Ultima, chaque fois avec un design et une méthode d'obtention différents.", "Birth by Sleep, Re:coded and Dream Drop Distance also have their own Ultima Weapon, each with a different design and method of obtaining."),
    ],
    sources: [
  ...
  "way-to-the-dawn": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-ii",
        text: L(
      "Riku passe presque tout Kingdom Hearts II dans l'ombre, sous l'apparence d'Ansem qu'il a prise pour vaincre Roxas. Dans le Monde qui n'existe pas, il est révélé que le mystérieux encapuchonné manie une Keyblade ; c'est Point du Jour, qui apparaît dans sa main sans que le jeu explique sa transformation depuis l'Âme Éternelle. Il lance aussi une autre Keyblade, Appel du destin, à Kairi pour qu'elle puisse se défendre.\n\nUne fois Riku revenu à son apparence grâce à Naminé, il rejoint l'équipe comme allié jouable et combat avec Point du Jour aux côtés de Sora contre Xemnas, jusqu'au duel final où les deux amis, à la limite de leurs forces, ne survivent qu'en s'appuyant l'un sur l'autre. Ils regagnent ensuite les Îles du Destin par la porte de la lumière.",
  ...
  "destinys-embrace": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-iii",
        text: L(
      "Pour compléter les sept Gardiens de la Lumière, Yen Sid confie Kairi et Lea à Merlin, qui les entraîne dans un lieu hors du temps. Kairi y apprend à manier Appel du destin, écrivant ses progrès à Sora dans des lettres. Elle rejoint ensuite ses amis au Nécropole des Keyblades pour la bataille finale contre les treize ténèbres de Xehanort.\n\nElle y combat Xemnas et Saïx aux côtés de Sora et Lea, mais le Maître Xehanort la frappe pour pousser Sora à compléter la χ-blade. Sora la ramène ensuite au prix de son propre effacement. Dans Re Mind, la scène est rejouée : Kairi devient jouable avec Appel du destin contre le Maître Xehanort, aux côtés de Sora, et ses attaques révèlent un style aérien et fleuri.",
      ...
      },
      {
        game: "melody-of-memory",
        text: L(
      "Melody of Memory place Kairi au centre : endormie pour aider Ansem le Sage et les autres à retrouver la trace de Sora, elle parcourt en rêve les souvenirs de toute la saga. Au terme de ce voyage, elle affronte dans son cœur une manifestation du Maître Xehanort, et c'est avec Appel du destin qu'elle remporte ce combat, aidée par Sora sous forme de souvenir.\n\nRéveillée, Kairi rapporte ce qu'elle a vu, puis demande à Aqua de la prendre comme élève à la Contrée du Départ pour devenir une vraie Porteuse. Appel du destin est donc la Keyblade avec laquelle elle entame l'entraînement qui la conduit vers la suite de la saga.",
    ...
    trivia: [
      ...
      L("Kairi est jouable avec Appel du destin dans Re Mind et dans Melody of Memory, près de quinze ans après avoir reçu la Keyblade dans Kingdom Hearts II.", "Kairi is playable with Destiny's Embrace in Re Mind and in Melody of Memory, almost fifteen years after receiving the Keyblade in Kingdom Hearts II."),
    ],
    sources: [
  ...
  "two-become-one": {
    sections: [
      ...
      },
      {
        game: "358-2-days",
        text: L(
      "Dans 358/2 Days, la Keyblade de Roxas change de forme selon le Gear installé dans son panneau. Le Gear Zéro, l'un des plus puissants, lui donne l'apparence de Deux pour un ; si Roxas dispose de la capacité de manier deux Keyblades, ce même Gear fait apparaître Tendre Promesse et Souvenir Perdu.\n\nDeux pour un est donc, dans cet épisode, l'arme qui précède directement le double maniement final de Roxas, ce qui renforce son statut de « fusion » des deux Keyblades jumelles. Dans le mode Mission, Xion et Sora, qui utilisent les mêmes Gears que Roxas, peuvent eux aussi l'invoquer.",
  ...
  "earthshaker": {
    sections: [
      ...
      },
      {
        game: "birth-by-sleep",
        text: L(
      "Terra manie Trembleterre lors de l'examen de Maîtrise qui ouvre Birth by Sleep, à la Contrée du Départ. Face à Aqua, il laisse échapper une bouffée de ténèbres qui lui coûte le titre de Maître. Lorsqu'Eraqus l'envoie ensuite arrêter les Nescients et retrouver le Maître Xehanort, c'est avec cette Keyblade qu'il traverse le Bois des Nains, le Palais des Rêves, le Domaine Enchanté ou le Jardin Radieux.\n\nAu fil du voyage, Terra affronte des adversaires qui exploitent sa faiblesse : Maléfique, Hadès ou Braig, qu'il blesse au visage en cédant à ses ténèbres. Trembleterre est aussi la Keyblade avec laquelle Terra adoube sans le savoir Riku sur les Îles du Destin, lui transmettant le pouvoir de la Keyblade. Le jeu permet de la remplacer par de nombreux porte-clés glanés dans les mondes, mais elle demeure celle de son histoire jusqu'au Nécropole des Keyblades.",
      ...
      },
      {
        ...
        text: L(
      "Trembleterre est la matrice de deux Keyblades essentielles. La première est Terres condamnées, sa forme finale, que Terra obtient au Nécropole des Keyblades et qui devient l'arme de la Volonté Persistante. La seconde est indirecte : la Keyblade de Riku, car c'est le rite accompli avec Trembleterre qui fait de lui un Porteur, puis conduit la Chaîne Royale à choisir Sora à sa place.\n\nDans Kingdom Hearts III, c'est Terres condamnées et non Trembleterre que l'on voit dans les mains de l'armure de Terra ; Trembleterre reste ainsi une Keyblade propre à Birth by Sleep, où elle apparaît aussi dans les tenues et données de Terra dans l'Arène des Mirages.",
  ...
  "ends-of-the-earth": {
    sections: [
      ...
      },
      {
        game: "birth-by-sleep",
        text: L(
      "Terra obtient Terres condamnées au Nécropole des Keyblades, au moment d'affronter le Maître Xehanort et Vanitas avec Aqua et Ventus. Le combat tourne au désastre : Ven est gelé, Aqua blessée, et Terra, cédant à sa colère, se laisse envahir par les ténèbres. Xehanort en profite pour transférer son cœur dans le corps de Terra, donnant naissance à Terra-Xehanort.\n\nMais la volonté de Terra survit dans son armure : celle-ci se relève, ramasse Terres condamnées et affronte Terra-Xehanort dans un duel où le joueur contrôle l'armure. Victorieuse, elle reste ensuite agenouillée dans le désert, Keyblade plantée devant elle : c'est la Volonté Persistante. Dans l'Épisode Final, Aqua affronte Terra-Xehanort au Jardin Radieux, sans que la Keyblade de Terra ne lui revienne.",
      ...
      },
      {
        game: "kingdom-hearts-iii",
        text: L(
      "Au Nécropole des Keyblades, lorsque Terra-Xehanort vient de terrasser Ven et Aqua et menace Sora, l'armure de Terra surgit de terre, Terres condamnées au poing, répondant à l'appel de Sora et aux liens de Terra. La Volonté Persistante affronte son propre corps possédé et le tient en échec assez longtemps pour permettre à Sora de continuer, avant que leur duel ne les emporte tous deux hors du champ de bataille.\n\nPlus tard, lorsque le cœur de Terra reprend le contrôle grâce à Sora et Ven, l'armure et la Keyblade lui reviennent enfin : Terra se bat une dernière fois contre Xehanort aux côtés d'Aqua et Ven, puis rentre avec eux à la Contrée du Départ. Re Mind ajoute un épisode où Terra redevient jouable avec Terres condamnées.",
    ...
    sections: [
      {
        title: L("Origines", "Origins"),
        text: L(
      "Brise Légère est la Keyblade de Ventus. Fine et légère, dans des tons bronze et vert, elle se termine par une lame en spirale qui évoque une rafale de vent, et son porte-clés reprend l'emblème de Ven, le même que celui de Terra et d'Aqua. Ven la tient à l'envers, lame vers l'arrière, ce qui définit son style de combat rapide et acrobatique, un maniement que Roxas retrouvera instinctivement des années plus tard.\n\nSon nom, « le vent vagabond », renvoie à l'élément de Ventus et à son caractère : un garçon curieux qui part sans permission derrière ses amis. Elle est présentée dans Birth by Sleep comme sa Keyblade de départ, mais l'histoire révèle qu'il la maniait déjà sous le Maître Xehanort, avant d'être confié à Eraqus.",
      ...
      },
      {
        game: "birth-by-sleep",
        text: L(
      "Ventus n'est pas autorisé à passer l'examen de Maîtrise, mais lorsque Vanitas lui laisse entendre que Terra va changer, il quitte la Contrée du Départ avec Brise Légère pour le rejoindre. Son voyage le mène au Bois des Nains, au Palais des Rêves, au Domaine Enchanté, à Disney Ville, au Jardin Radieux et au Pays Imaginaire, où il croise Mickey et affronte les Nescients.\n\nAu Nécropole des Keyblades, il apprend qu'il est la moitié de lumière d'un cœur brisé par Xehanort, et que sa fusion avec Vanitas doit forger la χ-blade. Il combat pourtant Vanitas, est possédé, et livre un ultime duel à l'intérieur de son propre cœur, Brise Légère contre Void Gear, pour détruire la χ-blade. Son cœur, brisé, trouve refuge chez Sora, tandis qu'Aqua cache son corps endormi au Manoir Oblivion.",
    ...
    sections: [
      {
        title: L("Origines", "Origins"),
        text: L(
      "Larme de pluie est la Keyblade de départ d'Aqua. Fine, bleue et argentée, elle se termine par des dents effilées qui rappellent des gouttes d'eau ou des pétales, et son porte-clés reprend l'emblème commun aux trois élèves d'Eraqus. Sa garde arrondie et ses lignes fluides contrastent avec la lourdeur de Trembleterre : elle est faite pour la vitesse, les pirouettes et la magie.\n\nSon nom original, Rainfell, « la pluie tombée », s'accorde à l'élément d'Aqua, l'eau ; le nom français, Larme de pluie, ajoute la magie qui caractérise son porteur. Elle est la Keyblade avec laquelle Aqua devient Maître, la seule des trois élèves à réussir l'examen, et elle laisse place plus tard à Tempête, sa forme aboutie.",
          "Rainfell is Aqua's starting Keyblade. Slim, blue and silver, it ends in tapered teeth that recall raindrops or petals, and its keychain carries the emblem shared by Eraqus's three students. Its rounded guard and flowing lines contrast with the heaviness of Earthshaker: it is built for speed, pirouettes and magic.\n\nIts original name, Rainfell, matches Aqua's element, water; the French name, Larme de pluie (“enchanted rain”), adds the magic that defines its wielder. It is the Keyblade with which Aqua becomes a Master, the only one of the three students to pass the exam, and it later gives way to Stormfall, its finished form.",
        ),
      },
      {
        game: "birth-by-sleep",
        text: L(
      "Aqua manie Larme de pluie dès l'examen de Maîtrise, qu'elle réussit là où Terra échoue. Eraqus la charge alors d'une double mission : suivre Terra pour surveiller ses ténèbres, et ramener Ventus. Son voyage la conduit dans les mêmes mondes que ses amis, où elle arrive souvent après eux et répare ce qu'ils ont laissé derrière : elle affronte Maléfique au Domaine Enchanté, aide Cendrillon, et protège la petite Kairi des Nescients au Jardin Radieux.\n\nCette dernière scène est décisive : en touchant la Keyblade d'Aqua, Kairi reçoit sans le savoir le pouvoir de devenir Porteuse. Aqua lance ensuite un sort de protection sur la fillette, puis, sur les Îles du Destin, choisit de ne pas faire de Sora un Porteur, estimant qu'un seul suffit dans une même famille d'amis. Larme de pluie reste son arme de l'histoire jusqu'au Nécropole des Keyblades.",
      ...
      },
      {
        title: L("Héritage", "Legacy"),
        text: L(
      "Larme de pluie disparaît du récit après Birth by Sleep. Au Nécropole des Keyblades, Aqua obtient Tempête, sa forme aboutie ; puis, dans l'Épisode Final, elle prend la Keyblade de son maître défunt, Garde du Maître, pour transformer la Contrée du Départ en Manoir Oblivion et affronter Terra-Xehanort. C'est Garde du Maître qu'elle conserve dans le Domaine des Ténèbres, dans 0.2 et dans Kingdom Hearts III.\n\nLa Keyblade bleue d'Aqua reste néanmoins essentielle à la saga : c'est elle que Kairi a touchée au Jardin Radieux, et donc l'origine indirecte de Appel du destin. Larme de pluie est ainsi la Keyblade par laquelle la lignée d'Eraqus atteint la nouvelle génération de Porteurs.",
  ...
  "stormfall": {
    sections: [
      ...
      },
      {
        title: L("Héritage", "Legacy"),
        text: L(
      "Tempête ne réapparaît pas dans les épisodes suivants : 0.2 et Kingdom Hearts III montrent Aqua avec Garde du Maître, y compris lorsque, corrompue par les ténèbres, elle affronte Sora sur la plage sombre. Tempête reste donc la Keyblade d'un seul jeu, mais d'un moment fondateur, celui où la χ-blade est détruite et où le sort des trois amis se scelle pour dix ans.\n\nEn jeu, elle offre un équilibre entre force et magie supérieur à Larme de pluie et convient particulièrement à la magie d'Aqua, que Birth by Sleep favorise avec ses sorts avancés et ses styles de commande. Kingdom Hearts III Re Mind, qui rend Aqua jouable, la montre avec Garde du Maître.",
    ...
    trivia: [
      L("Rainfell, Stormfall : les deux noms anglais forment un couple, tout comme Earthshaker et Ends of the Earth, ou Brise Légère et Lost Memory pour Ven.", "Rainfell and Stormfall form a pair, just like Earthshaker and Ends of the Earth, or Wayward Wind and Lost Memory for Ven."),
  ...
  "masters-defender": {
    sections: [
      ...
      },
      {
        game: "dark-road",
        text: L(
      "Dark Road remonte à la jeunesse d'Eraqus, élève à Scala ad Caelum aux côtés de Xehanort, sous l'enseignement du Maître Odin. Eraqus y est un jeune Porteur brillant, issu d'une lignée prestigieuse de Maîtres, et sa Keyblade est déjà Garde du Maître, signe de cet héritage familial.\n\nLe jeu montre les parties d'échecs entre Eraqus et Xehanort, plus tard rejouées dans Kingdom Hearts III, et les épreuves qui opposent les élèves aux Sans-cœur dans les mondes. Il éclaire ainsi la relation entre les deux amis, l'un attaché à la lumière et à la tradition, l'autre fasciné par les ténèbres, une opposition qui aboutira au duel de Birth by Sleep, Garde du Maître contre la Keyblade de Xehanort.",
      ...
      },
      {
        game: "birth-by-sleep",
        text: L(
      "Eraqus manie Garde du Maître lorsqu'il tente d'éliminer Ventus, persuadé que la destruction du garçon empêchera la χ-blade de renaître. Terra s'interpose et affronte son maître ; blessé, Eraqus baisse sa garde et est frappé dans le dos par le Maître Xehanort, qui lui prend la vie. Sa Keyblade reste à la Contrée du Départ.\n\nDans l'Épisode Final, Aqua rentre au château dévasté avec le corps endormi de Ven. Se souvenant des instructions d'Eraqus, elle prend Garde du Maître, l'enfonce dans la serrure de la salle du trône et transforme la Contrée du Départ en Manoir Oblivion, pour cacher Ven aux yeux de tous. Elle part ensuite au Jardin Radieux affronter Terra-Xehanort avec cette même Keyblade, puis la garde dans le Domaine des Ténèbres, où elle sombre pour sauver Terra.",
      ...
      },
      {
        game: "0-2-birth-by-sleep-a-fragmentary-passage",
        text: L(
      "0.2 suit Aqua dans le Domaine des Ténèbres, Garde du Maître à la main, pendant les événements du premier Kingdom Hearts. Elle y traverse les ruines déformées des mondes qu'elle a visités, le Palais des Rêves, le Bois des Nains, le Domaine Enchanté, et affronte les Sans-cœur ainsi que son propre reflet, une ombre d'elle-même née de ses doutes.\n\nElle finit par rencontrer Mickey, et tous deux gagnent la porte de Kingdom Hearts au moment où Sora la ferme. Aqua se sacrifie une seconde fois pour retenir une Tour Démoniaque et laisser Mickey rester près de la porte. Sur le plan du jeu, Garde du Maître est la seule Keyblade d'Aqua dans cet épisode ; elle y dispose de nouvelles commandes et de styles de combat qui préfigurent Kingdom Hearts III.",
      ...
      },
      {
        game: "kingdom-hearts-iii",
        text: L(
      "Après dix ans dans le Domaine des Ténèbres, Aqua a cédé : lorsque Sora et Riku la retrouvent sur la plage sombre, elle est devenue Anti-Aqua et brandit Garde du Maître contre eux, dans un combat où la Keyblade de son maître sert les ténèbres. Vaincue, elle est ramenée à la lumière et conduite au Manoir Oblivion, où elle utilise Garde du Maître sur la serrure pour rendre au château sa forme de Contrée du Départ.\n\nAu Nécropole des Keyblades, elle combat avec cette Keyblade aux côtés de Ven contre Vanitas et Terra-Xehanort, avant d'être engloutie dans les ténèbres puis sauvée par Sora. Re Mind la rend jouable, toujours avec Garde du Maître. Dans Melody of Memory, elle accepte enfin Kairi comme élève, transmettant à son tour l'enseignement d'Eraqus.",
    ...
    trivia: [
      L("Le nom japonais, マスターキーパー (Master Keeper), a été traduit par Master's Defender en anglais et Garde du Maître en français.", "The Japanese name, マスターキーパー (Master Keeper), became Master's Defender in English and Garde du Maître in French."),
      L("Dans Birth by Sleep, Garde du Maître devient équipable par Aqua dès le début de l'Épisode Final, avec de bonnes statistiques équilibrées.", "In Birth by Sleep, Master's Defender becomes equippable by Aqua from the start of the Final Episode, with good balanced stats."),
    ],
    sources: [
  ...
  "void-gear": {
    sections: [
      ...
      },
      {
        game: "birth-by-sleep",
        text: L(
      "Vanitas manie Void Gear dès sa première apparition, lorsqu'il provoque Ventus à la Contrée du Départ pour le pousser à suivre Terra. Il poursuit Ven de monde en monde, lâche les Nescients derrière lui, affronte Aqua en chemin, puis attend les trois amis au Nécropole des Keyblades. Là, il vainc Ventus, fusionne avec lui et forge une χ-blade incomplète, en manie la lame face à Aqua et Mickey.\n\nÀ l'intérieur du cœur de Ven, le duel final oppose Brise Légère à Void Gear ; Ven l'emporte au prix de son propre cœur, et la χ-blade éclate. Void Gear est aussi la Keyblade obtenue par le joueur en battant le Vestige de Vanitas, boss secret qui attend au Nécropole des Keyblades après la fin de l'histoire : une arme puissante pour Terra, Ven ou Aqua, aux couleurs de leur ennemi.",
  ...
  "no-name": {
    sections: [
      ...
      },
      {
        game: "birth-by-sleep",
        text: L(
      "Le Maître Xehanort manie Innommée tout au long de Birth by Sleep. C'est avec elle qu'il brise le cœur de Ventus pour créer Vanitas, qu'il frappe Eraqus dans le dos et qu'il gèle Ven au Nécropole des Keyblades. Dans le combat final contre Terra, il l'utilise pour libérer son propre cœur et s'emparer du corps de son adversaire, un acte qui donne naissance à Terra-Xehanort.\n\nLe jeu offre aussi une version jouable de Innommée : elle récompense la victoire contre la Silhouette Mystérieuse, boss secret du Nécropole des Keyblades qui se révélera être le Jeune Xehanort. Ses statistiques élevées en font l'une des meilleures Keyblades pour les trois héros, aux côtés de l'Ultima et de Void Gear.",
      ...
      },
      {
        game: "kingdom-hearts-iii",
        text: L(
      "Innommée accompagne le Maître Xehanort jusqu'au bout de son plan. Au Nécropole des Keyblades, il la manie pour frapper Kairi et forcer Sora à compléter la χ-blade, puis à Scala ad Caelum, où il affronte Sora, Donald et Dingo dans un combat final rythmé par ses attaques de temps et de lumière. Vaincu, il remet la χ-blade à Sora et disparaît avec Eraqus.\n\nInnommée tombe alors au sol. Xigbar, laissé pour mort, réapparaît, la ramasse et révèle qu'il est Luxu : la Keyblade est revenue à son premier porteur, sa mission accomplie. Il convoque ensuite les Prophètes autour de la boîte noire. Dans Re Mind, Innommée est encore l'arme du Maître Xehanort dans son combat de données, le plus exigeant des treize.",
    ...
    trivia: [
      L("Innommée est la seule Keyblade présente dans presque toutes les époques de la saga, de l'Âge des Fées à Kingdom Hearts III.", "No Name is the only Keyblade present in almost every era of the saga, from the Age of Fairy Tales to Kingdom Hearts III."),
  ...
  "keyblade-of-heart": {
    sections: [
      ...
      },
      {
        title: L("Héritage", "Legacy"),
        text: L(
      "Le coup porté par Sora avec la Keyblade de Cœur est l'événement fondateur de toute la suite de la saga. En perdant brièvement son cœur, Sora donne naissance à un Simili, Roxas, apparu dans la Cité du Crépuscule et recruté par l'Organisation XIII ; et parce que le cœur libéré est celui de Kairi, une seconde Simili voit le jour : Naminé, capable de manipuler les souvenirs de Sora.\n\nChain of Memories, 358/2 Days et Kingdom Hearts II découlent directement de cet instant. Xion elle-même, réplica façonnée à partir des souvenirs de Sora, n'existe que parce que Roxas existe. La Keyblade de Cœur, arme d'un seul combat, est ainsi la clé de la trilogie de Xehanort.",
  ...
  "bond-of-flame": {
    sections: [
      ...
      },
      {
        title: L("Héritage", "Legacy"),
        text: L(
      "Ignescence n'est plus équipable après Kingdom Hearts II, mais son imagerie survit. Dans Dream Drop Distance, Lea, redevenu humain, s'entraîne auprès de Merlin et des fées et invoque une Keyblade de ses propres mains à la Tour Mystérieuse ; dans Kingdom Hearts III, cette Keyblade, Libérateur de Flammes, reprend le chakram et les flammes de Ignescence.\n\nLea la manie au Nécropole des Keyblades pour protéger Sora et Kairi, puis retrouve Roxas et Xion. Ignescence reste ainsi, dans la mémoire des joueurs, la première trace du chemin qui a mené Axel, ennemi de Sora, à devenir un Gardien de la Lumière.",
