  ...
  "unversed": {
    sections: [
      ...
      },
      {
        game: "birth-by-sleep",
        text: L(
          "Les Nescients envahissent les mondes dès que Terra, Aqua et Ventus quittent la Contrée du Départ. Ils s'attaquent à la Cité des Nains, au Palais des Rêves, à l'Île Enchantée, au Jardin Radieux, et leur présence sert de fil conducteur aux trois trajets parallèles.\n\nCertains prennent des formes de boss : l'Armure Trinité, seule occasion pour le trio de combattre ensemble, ou l'Iron Imprisoner que Hadès garde enchaîné. Le Maître Eraqus s'inquiète de leur apparition sans en comprendre l'origine, et Yen Sid met en garde contre le porteur masqué qui les accompagne. La vérité n'éclate qu'au Nécropole des Keyblades : Vanitas les fabrique pour épuiser Ventus et le forcer à fusionner avec lui, afin de forger la χ-blade.",
  ...
  "demon-tower": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-iii",
        text: L(
          "Kingdom Hearts III ouvre sur des Tours Démoniaques. Riku et Mickey, partis dans le Domaine des Ténèbres retrouver Aqua, en affrontent au Rivage Obscur ; l'une d'elles immobilise même le roi sous le contrôle d'Aqua corrompue par les ténèbres.\n\nSora, de son côté, en croise une dès son retour à la Cité du Crépuscule, avant que le voyage ne commence vraiment. Plus tard, au Nécropole des Keyblades, Riku des Ténèbres en invoque une légion pour éprouver les Gardiens de la Lumière : chaque porteur doit se frayer un passage à travers ces colonnes, avant que la Marée Démoniaque ne les submerge tous. Les Tours servent ainsi de mesure constante de la puissance brute que Xehanort peut jeter sur ses adversaires sans y consacrer un seul de ses treize porteurs.",
