...
export const lore: Record<string, EntryLore> = {
  ...
  "disney-town": {
    ...
    trivia: [
      ...
      L("Rumble Racing est jouable en dehors du monde, depuis le Colisée des Ombres, en solo comme en multijoueur.", "Rumble Racing can be played outside the world, from the Mirage Arena, solo or in multiplayer."),
  ...
  "mirage-arena": {
    ...
    trivia: [
      L("Le Colisée des Ombres est le seul « monde » de Birth by Sleep accessible dès le début de l'aventure pour les trois héros.", "The Mirage Arena is the only Birth by Sleep “world” available from the start of the adventure for all three heroes."),
