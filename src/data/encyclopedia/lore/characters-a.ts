...
export const lore: Record<string, EntryLore> = {
  ...
  "terra": {
    ...
    trivia: [
      ...
      L("Ses Keyblades successives, Trembleterre puis Terres condamnées, portent toutes deux des noms liés à la terre.", "His successive Keyblades, Earthshaker and Ends of the Earth, both bear names tied to the earth."),
    ],
    sources: [
