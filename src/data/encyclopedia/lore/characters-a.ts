...
export const lore: Record<string, EntryLore> = {
  ...
  "kairi": {
    ...
    trivia: [
      ...
      L("Sa Keyblade, Destin Florissant, est ornée de fleurs et de coquillages thalassa qui rappellent son porte-bonheur.", "Her Keyblade, Destiny's Embrace, is decorated with flowers and thalassa shells that recall her lucky charm."),
  ...
  "terra": {
    ...
    trivia: [
      ...
      L("Ses Keyblades successives, Gardien de la Terre puis Confins de la Terre, portent toutes deux des noms liés à la terre.", "His successive Keyblades, Earthshaker and Ends of the Earth, both bear names tied to the earth."),
    ],
    sources: [
  ...
  "eraqus": {
    ...
    trivia: [
      ...
      L("Sa Keyblade, Maître Gardien, est celle qu'Aqua manie dans 0.2 Birth by Sleep.", "His Keyblade, Master's Defender, is the one Aqua wields in 0.2 Birth by Sleep."),
    ],
    sources: [
  ...
  "master-xehanort": {
    ...
    trivia: [
      ...
      L("Sa Keyblade, Sans-Nom, est celle que le Maître des Maîtres a transmise à Luxu, ce qui explique l'œil qui l'orne.", "His Keyblade, No Name, is the one the Master of Masters passed to Luxu, which explains the eye that adorns it."),
  ...
  "xemnas": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-iii",
        text: L(
          "Xemnas apparaît dès l'ouverture de Kingdom Hearts III au Jardin Radieux, aux côtés d'Ansem, et prend part à la première bataille du Cimetière des Keyblades, où les Gardiens de la Lumière sont anéantis par la Marée Démoniaque avant que le Pouvoir de l'éveil ne change le cours des choses. Lors de la seconde bataille, il enlève Kairi et la livre au Maître Xehanort, qui la brise pour forger la χ-blade.\n\nIl affronte ensuite Sora, épaulé par Roxas et Xion, revenus à eux, et par Lea. Vaincu, Xemnas confesse ressentir enfin la peur et le regret, et s'interroge sur ce que cela dit d'un cœur qu'il prétendait ne pas avoir. Re Mind lui donne, avec Ansem et le Jeune Xehanort, un combat commun contre Sora, Riku et Mickey, et une version de données dans l'épisode Limitcut.",
    ...
    sections: [
      {
        title: L("Origines", "Origins"),
        text: L(
          "Terra-Xehanort désigne le corps de Terra habité par le cœur du Maître Xehanort, à partir de la fin de Birth by Sleep. Il a l'apparence de Terra, mais les cheveux argentés, les yeux dorés et la voix de Xehanort : un être hybride, dans lequel deux cœurs se disputent le contrôle. C'est ce Xehanort-là, amnésique, qui devient l'apprenti d'Ansem le Sage au Jardin Radieux, mène les expériences sur les ténèbres et donne naissance à Ansem, Chercheur des Ténèbres, et à Xemnas.\n\nIl est donc le chaînon manquant entre le vieux Maître de Birth by Sleep et les antagonistes des premiers jeux, ce qui explique que le nom « Xehanort » recouvre autant de visages. Ramené par le voyage temporel dans Kingdom Hearts III, il devient l'un des treize Chercheurs des Ténèbres et affronte enfin, en personne, ceux dont il a brisé la vie.",
          "Terra-Xehanort refers to Terra's body inhabited by Master Xehanort's heart, from the end of Birth by Sleep onwards. He has Terra's appearance but Xehanort's silver hair, golden eyes and voice: a hybrid being in which two hearts fight for control. It is this amnesiac Xehanort who becomes Ansem the Wise's apprentice in Radiant Garden, conducts the experiments on darkness and gives birth to Ansem, Seeker of Darkness, and Xemnas.\n\nHe is therefore the missing link between the old Master of Birth by Sleep and the antagonists of the first games, which explains why the name “Xehanort” covers so many faces. Brought back through time travel in Kingdom Hearts III, he becomes one of the thirteen Seekers of Darkness and finally faces, in person, those whose lives he shattered.",
        ),
      },
      {
        game: "birth-by-sleep",
        text: L(
          "Terra-Xehanort naît au Cimetière des Keyblades lorsque le Maître Xehanort se transperce le cœur pour le projeter dans Terra. Aussitôt, la Volonté Persistante de Terra l'affronte et le vainc. Il se retrouve ensuite au Jardin Radieux, où Aqua le poursuit ; le cœur de Terra résiste de l'intérieur si fort que Xehanort tente de s'en débarrasser en se frappant lui-même avec sa Keyblade, avant de sombrer dans les ténèbres. Aqua le sauve au prix de sa propre liberté.\n\nRecueilli dans les rues de la ville par Ansem le Sage et Braig, il ne se souvient que de son nom, Xehanort, et devient l'apprenti le plus brillant du savant. Les rapports secrets racontent la suite : ses expériences sur le cœur, ses complices, la trahison d'Ansem, puis le geste qui scinde son être en un Sans-cœur et un Simili. Sa mémoire de Terra survit dans Xemnas, qui parle à l'armure d'Aqua comme à une amie.",
          "Terra-Xehanort is born at the Keyblade Graveyard when Master Xehanort pierces his own heart to cast it into Terra. At once, Terra's Lingering Will confronts and defeats him. He then turns up in Radiant Garden, where Aqua pursues him; Terra's heart resists from within so fiercely that Xehanort tries to be rid of it by striking himself with his Keyblade, before sinking into darkness. Aqua saves him at the cost of her own freedom.\n\nTaken in from the city streets by Ansem the Wise and Braig, he remembers only his name, Xehanort, and becomes the scholar's most brilliant apprentice. The secret reports tell the rest: his experiments on the heart, his accomplices, the betrayal of Ansem, then the act that splits his being into a Heartless and a Nobody. His memory of Terra survives in Xemnas, who speaks to Aqua's armour as to a friend.",
        ),
      },
      {
        game: "kingdom-hearts-iii",
        text: L(
          "Ramené d'une époque antérieure à sa scission par le voyage temporel, Terra-Xehanort siège dans la véritable Organisation XIII, accompagné du Gardien, le Sans-cœur dans lequel est enfermé le cœur de Terra. Il se présente aux Gardiens au Cimetière des Keyblades et, lors du premier assaut, terrasse Aqua et Ventus sans effort, prélude à l'anéantissement général par la Marée Démoniaque.\n\nLorsque Sora rétablit le cours des événements, Terra-Xehanort affronte de nouveau Aqua et Ventus, jusqu'à l'intervention de la Volonté Persistante appelée par Naminé. Acculé de l'intérieur par le cœur de Terra, qui répond à l'appel de ses amis, il est chassé du corps qu'il occupait depuis treize ans : Terra reprend possession de lui-même, et le Gardien libère son cœur. Re Mind propose de rejouer cet affrontement avec Aqua et Ventus, et ajoute un combat de données contre lui dans l'épisode Limitcut.",
          "Brought back through time travel from an era before his splitting, Terra-Xehanort sits in the real Organization XIII, accompanied by the Guardian, the Heartless in which Terra's heart is locked. He confronts the Guardians at the Keyblade Graveyard and, in the first assault, crushes Aqua and Ventus effortlessly, a prelude to the general annihilation by the Demon Tide.\n\nWhen Sora restores the course of events, Terra-Xehanort fights Aqua and Ventus again, until the Lingering Will, called by Naminé, intervenes. Cornered from within by Terra's heart, which answers his friends' call, he is driven out of the body he had occupied for thirteen years: Terra regains possession of himself, and the Guardian releases his heart. Re Mind lets players replay that clash as Aqua and Ventus, and adds a data battle against him in the Limitcut episode.",
        ),
      },
    ],
    trivia: [
      L("Terra-Xehanort est doublé par Richard Epcar en anglais et par Akio Ōtsuka en japonais, les voix d'Ansem, Chercheur des Ténèbres.", "Terra-Xehanort is voiced by Richard Epcar in English and Akio Ōtsuka in Japanese, the voices of Ansem, Seeker of Darkness."),
      L("Le combat contre lui au Jardin Radieux est le boss final du scénario d'Aqua dans Birth by Sleep.", "The battle against him in Radiant Garden is the final boss of Aqua's scenario in Birth by Sleep."),
      L("Dans Kingdom Hearts II, une image de lui en apprenti d'Ansem apparaît dans l'ordinateur de la Forteresse Oubliée, et Xemnas conserve ses traits.", "In Kingdom Hearts II, a picture of him as Ansem's apprentice appears in the Hollow Bastion computer, and Xemnas keeps his features."),
    ],
    sources: [
  ...
  "ephemer": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-chi",
        text: L(
          "Ephemer rencontre le Joueur à Daybreak Town, alors que les Unions rivalisent pour collecter la lumière. Intrigué par les secrets des Prophètes, il entraîne son nouvel ami dans une exploration de la ville, puis disparaît sans laisser de trace : Ava l'a choisi pour devenir l'un des chefs des Pissenlits, les Porteurs qu'elle met à l'abri de la guerre à venir. Le Joueur et Skuld partent à sa recherche, sans le retrouver avant la catastrophe.\n\nDans Union χ, après la Guerre des Keyblades, Ephemer dirige les Pissenlits avec Skuld, Ventus, Brain et Lauriam, dans une Daybreak Town reconstituée. Les cinq chefs affrontent la trahison des instructions laissées par Ava, la disparition de Strelitzia et l'entité appelée les Ténèbres, cachée parmi eux. Au terme de l'histoire, Ephemer et Skuld restent pour transmettre l'avenir aux mondes, et Ephemer est vu, bien plus tard, à Scala ad Caelum, dont il semble être l'un des fondateurs.",
    ...
    trivia: [
      ...
      L("Comme tous les Porteurs de Daybreak Town, il manie Lumière Stellaire, la Keyblade de l'Âge des Fées.", "Like every wielder of Daybreak Town, he wields Starlight, the Keyblade of the Age of Fairy Tales."),
    ],
    sources: [
