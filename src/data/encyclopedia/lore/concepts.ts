  ...
  "keyblade-war": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-chi",
        text: L(
          "Union χ montre comment la guerre arrive : non par une invasion, mais par la défiance. Les Prophètes, chacun détenteur d'un fragment de prophétie, soupçonnent l'un des leurs d'être le traître annoncé. Faute de pouvoir en parler franchement, ils accumulent les décisions unilatérales, lèvent des forces, préparent des ripostes.\n\nLa collecte de la Lux, censée préserver la lumière, devient une compétition entre Unions. Les Porteurs de base, qui ne savent rien des chapitres du livre, obéissent à leur chef et finissent par se battre entre camarades. Le Cimetière des Keyblades se remplit de milliers d'armes plantées dans la terre. Ava, prévoyant l'issue, avait formé les Unions Croisées, un groupe de jeunes Porteurs tenus à l'écart du combat pour reconstruire le monde après coup : c'est par eux que la lignée des Porteurs survit.",
    ...
    trivia: [
      L(
        "Le Cimetière des Keyblades apparaît dès Kingdom Hearts II dans un souvenir, bien avant que Birth by Sleep n'en explique l'origine.",
