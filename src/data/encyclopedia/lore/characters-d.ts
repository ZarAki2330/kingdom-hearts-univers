...
export const lore: Record<string, EntryLore> = {
  ...
  "gullwings": {
    ...
    trivia: [
      ...
      L("La Keyblade Albatros qu'elles offrent porte le nom anglais de leur équipage, les Gullwings.", "The Gull Wing Keyblade they give is named after their crew's English name, the Gullwings."),
    ],
    sources: [
