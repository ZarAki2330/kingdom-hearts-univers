...
export const lore: Record<string, EntryLore> = {
  ...
  "hiro": {
    ...
    trivia: [
      L("San Fransokyo est le dernier monde Disney visité dans Kingdom Hearts III avant le Cimetière des Keyblades.", "San Fransokyo is the last Disney world visited in Kingdom Hearts III before the Keyblade Graveyard."),
  ...
  "cinderella": {
    ...
    trivia: [
      L("Le Château des Rêves n'apparaît que dans Birth by Sleep : dans le premier Kingdom Hearts, Cendrillon n'est vue qu'à la Forteresse Oubliée.", "Castle of Dreams appears only in Birth by Sleep: in the first Kingdom Hearts, Cinderella is seen only at Hollow Bastion."),
