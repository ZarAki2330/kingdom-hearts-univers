...
export const lore: Record<string, EntryLore> = {
    ...
    sections: [
      {
        title: L("Apparence et symbolique", "Appearance and symbolism"),
        text: L(
          "Hunny Spout est une Keyblade jaune et dorée dont la lame se termine par un large pot de miel renversé, prêt à couler. Des alvéoles de rayon de miel couvrent la garde, de petites abeilles ornent le manche, et le porte-clés est une figurine de Winnie l'ourson. L'ensemble est rond, épais et joyeux, à l'opposé des armes anguleuses de la fin du jeu.\n\nElle est l'héritière directe de Doux Souvenirs, la Keyblade de la Forêt des Rêves Bleus dans Kingdom Hearts II, et reprend la même idée : un monde qui n'est pas menacé par les Sans-cœur mais par l'oubli. La Forêt des Rêves Bleus n'existe qu'à l'intérieur d'un livre confié à Merlin, et son enjeu est toujours le même : ne pas laisser disparaître les souvenirs d'enfance de ceux qu'on aime.",
  ...
  "master-keeper": {
    ...
    trivia: [
      L("Xion réapparaît Keyblade en main au Cimetière des Keyblades dans Kingdom Hearts III, aux côtés de Roxas et d'Axel.", "Xion returns Keyblade in hand at the Keyblade Graveyard in Kingdom Hearts III, alongside Roxas and Axel."),
    ],
    ...
    sections: [
      {
        title: L("Apparence et symbolique", "Appearance and symbolism"),
        text: L(
          "Dual Disc est une Keyblade noire striée de bleu lumineux, dans l'exacte esthétique de Tron : L'Héritage. Sa lame est une barre de circuits, sa garde est formée de deux disques d'identité montés l'un contre l'autre, ses dents évoquent un connecteur, et son porte-clés est un troisième disque miniature.\n\nLe disque d'identité est l'objet central de l'univers de Tron : il contient toute la mémoire d'un programme, sert d'arme et de preuve d'existence, et le perdre revient à disparaître. La Keyblade succède au Débogueur Photon de Kingdom Hearts II, qui reprenait le premier film ; le passage à la Grille, avec ses noirs profonds et ses lignes de néon, marque le saut d'une génération de décors à l'autre au sein de la même série de mondes numériques.",
  ...
  "unbound": {
    sections: [
      ...
      },
      {
        game: "dream-drop-distance",
        text: L(
          "Unbound est l'une des récompenses de complétion de Dream Drop Distance : elle s'obtient en menant à son terme la collection des Esprits, c'est-à-dire en créant chacun des Avale-Rêves alliés du jeu à partir des matières de rêve récoltées dans les mondes endormis.\n\nSes statistiques la placent juste derrière l'Arme Ultime, avec un profil équilibré et sans faiblesse, et elle donne accès aux meilleures Attaques Ultimes du porteur. Elle est donc l'arme de ceux qui ont épuisé le contenu annexe avant d'affronter les combats les plus durs, notamment les affrontements secrets ajoutés dans la version HD du jeu. Sa présence dans l'arsenal résume une part importante de l'épisode : ici, la puissance ne vient pas des mondes traversés mais des compagnons que le joueur a lui-même façonnés.",
