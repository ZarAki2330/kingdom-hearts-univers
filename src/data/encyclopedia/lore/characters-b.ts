...
export const lore: Record<string, EntryLore> = {
  ...
  "jiminy-cricket": {
    ...
    sources: [
      { label: "Kingdom Hearts Wiki — Jiminy Cricket", url: "https://kingdomhearts.fandom.com/wiki/Jiminy_Cricket" },
    ],
  },
  ...
  "leon": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-iii",
        text: L(
          "Absent du jeu de base, Léon revient dans l'épisode Limitcut de Re Mind. Un an après la bataille du Cimetière des Keyblades, Riku, Mickey et les apprentis d'Ansem cherchent Sora ; on retrouve Léon au Jardin Radieux, en compagnie d'Aerith et de Yuffie, dans le bureau d'Ansem où Ienzo analyse les données.\n\nSa présence, brève, confirme que le Comité de Restauration a mené sa tâche à bien et que le Jardin Radieux est redevenu une cité habitée. C'est depuis cet ordinateur que sont lancés les treize combats de données contre l'Organisation, sous le regard des survivants de la première aventure.",
  ...
  "luxord": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-iii",
        text: L(
          "Reconstitué puis rappelé par Xehanort, Luxord traverse les Caraïbes à bord d'un navire de l'Organisation, à la recherche de la boîte noire, qu'il croit cachée quelque part dans ces eaux. Il défie Sora à une course maritime, échange quelques mots avec Jack Sparrow et ne se départ jamais de sa courtoisie.\n\nAu Cimetière des Keyblades, il affronte Sora avec Marluxia et Larxene, puis seul, dans un jeu de cartes géantes où il faut retrouver la bonne carte parmi ses illusions. Vaincu, il remet à Sora une « carte joker » qui, dit-il, pourrait lui servir un jour. Il disparaît en pariant sur une revanche, et sa version de données attend dans Limitcut.",
