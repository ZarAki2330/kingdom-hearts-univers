  ...
  "maleficent": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts",
        text: L(
      "Depuis la Forteresse Oubliée, Maléfique dirige un conseil de méchants Disney et lance les Sans-cœur à l'assaut des mondes pour capturer les sept Princesses de Cœur. Elle recueille Riku après la destruction des Îles du Destin, lui fait miroiter le moyen de sauver Kairi et l'emploie à retrouver les princesses tout en dressant le garçon contre Sora.\n\nUne fois les princesses réunies, Maléfique affronte Sora dans sa chapelle, puis, transpercée par la Keyblade de Cœur que manie Riku possédé par Ansem, se change en dragon. Sora la terrasse, et Ansem, qui l'a manipulée depuis le début à travers Riku, ne laisse d'elle qu'un tas de cendres. Sa défaite prouve que la maîtresse des ténèbres n'était qu'un pion dans le plan du Sans-cœur de Xehanort.",
    ...
    trivia: [
      ...
      L("Dans Kingdom Hearts χ, une Maléfique venue du futur se retrouve brièvement à Ville de l'Aube, à l'époque des Prophètes.", "In Kingdom Hearts χ, a Maleficent from the future briefly finds herself in Daybreak Town, in the age of the Foretellers."),
    ],
    sources: [
  ...
  "larxene": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-chi",
        text: L(
      "À Ville de l'Aube, Elrena est une porteuse de Keyblade au caractère bien trempé, accompagnée de son Chirithy. Elle fait partie des Dandelions choisis par Ava pour survivre à la Guerre des Keyblades et, après celle-ci, se rapproche de Lauriam pour l'aider à retrouver sa sœur Strelitzia, qu'elle connaissait.\n\nElle participe ainsi à l'enquête qui conduit au lieu où Strelitzia a été tuée, et assiste à la confrontation entre Lauriam et Ventus. Kingdom Hearts χ montre une Elrena déjà cassante mais loyale envers Lauriam, sans expliquer comment tous deux perdent leur cœur avant de renaître en Similis à l'époque de Xemnas.",
