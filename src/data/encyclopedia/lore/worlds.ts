...
export const lore: Record<string, EntryLore> = {
  ...
  "castle-oblivion": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-iii",
        text: L(
      "Après avoir été délivrée du Domaine des Ténèbres par Sora, Aqua conduit ses amis au Manoir Oblivion. En tant que nouvelle gardienne des lieux, elle lève l'enchantement avec Garde du Maître : le château blanc reprend la forme de la Contrée du Départ, révélant la Salle de l'Éveil et Ventus endormi sur son trône. Vanitas surgit pour s'emparer du garçon, et c'est Sora, en libérant le cœur de Ventus abrité en lui, qui réveille enfin son ami.\n\nLe Manoir Oblivion cesse alors d'exister : il redevient un monde à ciel ouvert, base des Gardiens de la Lumière avant l'assaut du Nécropole des Keyblades. Dans l'épilogue et dans Re Mind, la Contrée du Départ restaurée accueille Terra, Aqua et Ventus, de nouveau réunis, ainsi que Kairi, qui y poursuit son entraînement.",
  ...
  "arendelle": {
    ...
    trivia: [
      ...
      L("La course de luge Frozen Slider est nécessaire pour obtenir l'un des Orichalque+ de l'Ultima.", "The Frozen Slider sledging race is required to obtain one of the Orichalcum+ for the Ultima Weapon."),
    ],
    sources: [
