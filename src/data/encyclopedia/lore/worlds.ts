...
export const lore: Record<string, EntryLore> = {
  ...
  "daybreak-town": {
    ...
    trivia: [
      ...
      L("La place à fontaine de Daybreak Town est reproduite presque à l'identique à Scala ad Caelum dans Kingdom Hearts III.", "Daybreak Town's fountain square is reproduced almost identically in Scala ad Caelum in Kingdom Hearts III."),
    ],
    sources: [
  ...
  "realm-of-darkness": {
    sections: [
      ...
      },
      {
        game: "birth-by-sleep",
        text: L(
          "Le Domaine des Ténèbres n'est pas exploré dans Birth by Sleep, mais il en est la destination tragique. Après la bataille du Cimetière des Keyblades, Aqua retrouve Terra-Xehanort au Jardin Radieux et le combat ; l'ennemi, dans un dernier sursaut de volonté de Terra, se plonge lui-même dans les ténèbres. Aqua se jette à sa suite et, pour le sauver, lui abandonne son armure et sa Keyblade afin qu'il remonte vers la lumière.\n\nElle reste seule dans le Domaine, sans Keyblade, décidée à en sortir un jour pour retrouver ses amis. L'épilogue « Blank Points » la montre sur la Marge Sombre, en compagnie d'Ansem le Sage, qui évoque Sora comme la clé capable de ramener ceux qui souffrent. Cet exil ouvre directement sur A fragmentary passage.",
  ...
  "mysterious-tower": {
    ...
    trivia: [
      ...
      L("La tour apparaît aussi comme monde endormi, la Symphonie de la Sorcellerie, dans Dream Drop Distance, sous une forme entièrement musicale.", "The tower also appears as a Sleeping World, Symphony of Sorcery, in Dream Drop Distance, in a fully musical form."),
    ],
    sources: [
