    ...
    sections: [
      {
        title: NATURE,
        text: L(
      "Le Médusin est un Nescient, l'une des créatures nées des émotions négatives de Vanitas dans Birth by Sleep. Il prend la forme d'une énorme gelée molle et tremblante, marquée du blason rouge et noir de l'espèce, et ses noms étrangers — Gluttonous Goo, « la gelée gloutonne », et le japonais Jelly Glee Tea — disent assez le ton comique de sa silhouette.\n\nIl appartient au contenu ajouté par le Final Mix du jeu et n'apparaît dans aucune scène du récit : c'est une créature de défi, conçue pour un mode annexe plutôt que pour l'histoire des trois apprentis.",
    ...
    sections: [
      {
        title: NATURE,
        text: L(
      "Pélisort est un Cauchemar, la variante hostile des Avale-Rêves qui hantent les Mondes Endormis. Son corps évoque un grand oiseau au long bec, coiffé d'un chapeau de sorcier étoilé et enveloppé d'une cape, silhouette qui renvoie directement à l'apprenti sorcier de Fantasia. Des runes et des notes de musique l'accompagnent quand il déploie ses ailes.\n\nOn le rencontre dans la Symphonie du Sorcier, le monde tiré du Fantasia de Disney, où les décors se composent au rythme de la musique de Moussorgski et de Beethoven. Fidèle à ce cadre, Pélisort combat en invoquant d'autres Cauchemars et en détournant la magie du lieu contre son adversaire, ce qui en fait un boss de soutien autant qu'un combattant direct.",
    ...
    sections: [
      {
        title: NATURE,
        text: L(
      "Le Chill Clawbster est le pendant glacé du Grimard ardent, un Cauchemar de la famille des Avale-Rêves. Sa carapace bleutée, ses pinces couvertes de givre et son souffle froid en font l'exact opposé de son jumeau de feu, jusque dans la façon dont il gèle la surface de l'eau pour se déplacer.\n\nOn l'affronte au Paradis des Garnements, le monde de Pinocchio, mais du côté de la mer plutôt que dans le ventre de Monstro. Le combat se joue donc sur une surface glissante et changeante, entre plaques de glace et vagues, avec un monstre qui plonge, resurgit et projette des éclats gelés. C'est un affrontement mobile, où le terrain lui-même est modifié en permanence par les attaques de la créature.",
