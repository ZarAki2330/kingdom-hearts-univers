  ...
  "elrena": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-iii",
        text: L(
          "Privée de son cœur à une époque ultérieure, Elrena devient Larxene et ne conserve de Daybreak Town que des impressions confuses. Membre de la véritable Organisation XIII, elle est envoyée à Arendelle, où elle se joue d'Elsa et sème le doute chez Sora, puis participe au piège du Nécropole des Keyblades.\n\nVaincue aux côtés de Marluxia et de Luxord, elle s'efface en retrouvant un fragment de mémoire : le nom d'une jeune fille qu'elle et Lauriam cherchaient autrefois. Sa dernière réplique, plus douce que tout ce qu'elle a dit auparavant, referme l'un des fils les plus inattendus de Kingdom Hearts III.",
