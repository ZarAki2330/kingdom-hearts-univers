  ...
  "braig": {
    sections: [
      ...
      },
      {
        game: "birth-by-sleep",
        text: L(
      "Braig apparaît d'abord au Jardin Radieux, où il met en scène l'enlèvement d'Ansem le Sage pour attirer Terra et l'engager sur la voie des ténèbres. Le duel tourne mal pour lui : Terra lui balafre le visage et lui coûte un œil, blessures qu'il gardera pour toujours.\n\nAu Nécropole des Keyblades, il révèle son alliance avec le Maître Xehanort et affronte Ventus. En échange de son aide, le vieux maître lui a promis une Keyblade et lui a implanté une part de son cœur, faisant de lui le premier des réceptacles. Cette scène établit Braig comme le complice de la première heure, celui qui savait tout du plan avant même la naissance de l'Organisation.",
      ...
      },
      {
        game: "kingdom-hearts-iii",
        text: L(
      "Xigbar accompagne les gardiens de Xehanort jusqu'au Nécropole des Keyblades, où il joue les meneurs de jeu, alimente les doutes de Sora et se moque de la fragilité des liens qui unissent ses amis. Vaincu, il feint la défaite et se laisse tomber du haut de Scala ad Caelum.\n\nL'épilogue révèle alors la vérité : le corps de Braig servait de réceptacle à Luxu, qui reprend le contrôle, récupère la Boîte noire et convoque les Prophètes de Ville de l'Aube pour la suite du plan du Maître des Maîtres. Braig, l'apprenti frondeur du Jardin Radieux, n'aura donc été qu'une étape dans une existence commencée des siècles plus tôt.",
  ...
  "lauriam": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-iii",
        text: L(
      "Réveillé dans une époque bien postérieure, Lauriam perd son cœur et devient Marluxia, numéro XI de l'Organisation XIII, sans conserver de souvenirs nets de Ville de l'Aube. Il reparaît dans la véritable Organisation XIII, envoyé notamment à Arendelle où il tente de séparer Sora de ses compagnons.\n\nAu Nécropole des Keyblades, il combat aux côtés de Larxene et de Luxord avant d'être vaincu. Sa disparition s'accompagne d'un éclair de mémoire : un nom de fleur, celui de Strelitzia, remonte à la surface, et il s'efface en promettant de la chercher encore. La scène relie explicitement l'Organisation à l'Âge des Fées et prépare les révélations du jeu suivant.",
  ...
  "elrena": {
    sections: [
      ...
      },
      {
        game: "kingdom-hearts-iii",
        text: L(
      "Privée de son cœur à une époque ultérieure, Elrena devient Larxene et ne conserve de Ville de l'Aube que des impressions confuses. Membre de la véritable Organisation XIII, elle est envoyée à Arendelle, où elle se joue d'Elsa et sème le doute chez Sora, puis participe au piège du Nécropole des Keyblades.\n\nVaincue aux côtés de Marluxia et de Luxord, elle s'efface en retrouvant un fragment de mémoire : le nom d'une jeune fille qu'elle et Lauriam cherchaient autrefois. Sa dernière réplique, plus douce que tout ce qu'elle a dit auparavant, referme l'un des fils les plus inattendus de Kingdom Hearts III.",
