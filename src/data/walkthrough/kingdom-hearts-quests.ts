    ...
    steps: [
      {
        ...
        text: L(
          "Speedster demande de battre le Monde du Chaos en moins de quinze heures de jeu. C'est confortable si l'on sait ce que l'on saute : la Forêt des Rêves Bleus, Monstro, le Colisée en grande partie, et l'un des deux mondes Atlantica ou Ville d'Halloween. Choisir la courbe d'expérience de l'Aube aide aussi. Faites-en une partie à part, en Débutant : viser la complétion et le chronomètre dans la même partie ne marche pas.\n\nUndefeated demande de terminer sans jamais utiliser de continuation. Il ne se rate pas vraiment : après un game over, ne choisissez jamais « Continuer », relancez depuis votre sauvegarde.\n\nUnchanging Armor demande de terminer sans jamais changer l'arme ni les accessoires de départ. C'est le plus contraignant : la Chaîne Royale et rien d'autre, du prologue au générique. À faire dans la même partie que Speedster, en Débutant.",
    ...
    tables: [
      {
        ...
        rows: [
    { world: L("Where the Bells Toll", "Where the Bells Toll"), what: L("Bronze", "Bronze"), where: L("Sceller le trou de serrure de la Ville de Traverse.", "Seal the Keyhole in Traverse Town.") },
    { world: L("The Rabbit Hole", "The Rabbit Hole"), what: L("Bronze", "Bronze"), where: L("Sceller le trou de serrure du Pays des Merveilles.", "Seal the Keyhole in Wonderland.") },
    { world: L("Junior Hero", "Junior Hero"), what: L("Bronze", "Bronze"), where: L("Sceller le trou de serrure du Colisée de l'Olympe.", "Seal the Keyhole in Olympus Coliseum.") },
    { world: L("Member of the Tribe", "Member of the Tribe"), what: L("Bronze", "Bronze"), where: L("Sceller le trou de serrure de la Jungle Profonde.", "Seal the Keyhole in Deep Jungle.") },
    { world: L("Magic Lamp", "Magic Lamp"), what: L("Bronze", "Bronze"), where: L("Sceller le trou de serrure d'Agrabah.", "Seal the Keyhole in Agrabah.") },
    { world: L("Honest Soul", "Honest Soul"), what: L("Bronze", "Bronze"), where: L("S'échapper de Monstro.", "Escape from Monstro.") },
    { world: L("Master of the Seas", "Master of the Seas"), what: L("Bronze", "Bronze"), where: L("Sceller le trou de serrure d'Atlantica.", "Seal the Keyhole in Atlantica.") },
    { world: L("Pumpkin Prince", "Pumpkin Prince"), what: L("Bronze", "Bronze"), where: L("Sceller le trou de serrure de la Ville d'Halloween.", "Seal the Keyhole in Halloween Town.") },
    { world: L("Pixie Dust", "Pixie Dust"), what: L("Bronze", "Bronze"), where: L("Sceller le trou de serrure du Pays Imaginaire.", "Seal the Keyhole in Neverland.") },
    { world: L("Pooh's Friend", "Pooh's Friend"), what: L("Bronze", "Bronze"), where: L("Sceller le trou de serrure de la Forêt des Rêves Bleus.", "Seal the Keyhole in the Hundred Acre Wood.") },
    { world: L("End of the World", "End of the World"), what: L("Bronze", "Bronze"), where: L("Sceller le trou de serrure de la Forteresse Oubliée.", "Seal the Keyhole in Hollow Bastion.") },
    { world: L("Oathkeeper", "Oathkeeper"), what: L("Bronze", "Bronze"), where: L("Recevoir le porte-clés Gardien du Serment.", "Receive the Oathkeeper Keychain.") },
        ],
      },
      {
        id: "colisee",
        ...
        columns: [L("Trophée", "Trophy"), L("Type", "Type"), L("Comment l'obtenir", "How to get it")],
        rows: [
    { world: L("Novice Hero", "Novice Hero"), what: L("Bronze", "Bronze"), where: L("Gagner la coupe de Phil.", "Win the Phil Cup.") },
    { world: L("Artisan Hero", "Artisan Hero"), what: L("Bronze", "Bronze"), where: L("Gagner la coupe de Pégase.", "Win the Pegasus Cup.") },
    { world: L("Hero of the Coliseum", "Hero of the Coliseum"), what: L("Bronze", "Bronze"), where: L("Gagner la coupe d'Hercule.", "Win the Hercules Cup.") },
    { world: L("Coliseum Champion", "Coliseum Champion"), what: L("Bronze", "Bronze"), where: L("Gagner la coupe de l'Hadès.", "Win the Hades Cup.") },
    { world: L("Supreme Soloist", "Supreme Soloist"), what: L("Bronze", "Bronze"), where: L("Réussir n'importe quel défi en solo au Colisée.", "Complete any solo challenge at the Coliseum.") },
    { world: L("Time Attacker", "Time Attacker"), what: L("Bronze", "Bronze"), where: L("Réussir n'importe quel défi contre la montre au Colisée.", "Complete any time trial challenge at the Coliseum.") },
    { world: L("The Frosty Giant", "The Frosty Giant"), what: L("Bronze", "Bronze"), where: L("Battre le Titan de glace lors de la coupe d'Or.", "Defeat the Ice Titan in the Gold Match.") },
    { world: L("One-Winged Angel", "One-Winged Angel"), what: L("Bronze", "Bronze"), where: L("Battre Séphiroth lors de la coupe de Platine.", "Defeat Sephiroth in the Platinum Match.") },
    { world: L("The Cloaked Shadow", "The Cloaked Shadow"), what: L("Bronze", "Bronze"), where: L("Battre le Fantôme à la tour de l'horloge.", "Defeat the Phantom at the Clock Tower.") },
    { world: L("The Sandy Blade", "The Sandy Blade"), what: L("Bronze", "Bronze"), where: L("Battre Kurt Zisa à Agrabah.", "Defeat Kurt Zisa in Agrabah.") },
    { world: L("He Who Doesn't Exist", "He Who Doesn't Exist"), what: L("Bronze", "Bronze"), where: L("Battre l'Inconnu à la Forteresse Oubliée.", "Defeat the Mysterious Man in Hollow Bastion.") },
        ],
      },
      {
        id: "collection",
        ...
        columns: [L("Trophée", "Trophy"), L("Type", "Type"), L("Comment l'obtenir", "How to get it")],
        rows: [
    { world: L("Treasure Hunter", "Treasure Hunter"), what: L("Bronze", "Bronze"), where: L("Ouvrir 100 coffres.", "Open 100 treasure chests.") },
    { world: L("From Rags to Riches", "From Rags to Riches"), what: L("Bronze", "Bronze"), where: L("Posséder plus de 10 000 munnies.", "Obtain over 10,000 munny.") },
    { world: L("Heartless Hunter", "Heartless Hunter"), what: L("Bronze", "Bronze"), where: L("Vaincre 2 000 Sans-cœur.", "Defeat 2,000 Heartless.") },
    { world: L("First Synthesis", "First Synthesis"), what: L("Bronze", "Bronze"), where: L("Fabriquer un objet à l'atelier.", "Synthesize an item in the Item Workshop.") },
    { world: L("Synthesis Novice", "Synthesis Novice"), what: L("Bronze", "Bronze"), where: L("Fabriquer trois objets différents.", "Create three different synthesis items.") },
    { world: L("Synthesis Amateur", "Synthesis Amateur"), what: L("Bronze", "Bronze"), where: L("Fabriquer quinze objets différents.", "Create fifteen different synthesis items.") },
    { world: L("Synthesis Vet", "Synthesis Vet"), what: L("Bronze", "Bronze"), where: L("Fabriquer trente objets différents.", "Create thirty different synthesis items.") },
    { world: L("Synthesis Master", "Synthesis Master"), what: L("Bronze", "Bronze"), where: L("Fabriquer les 33 objets de synthèse.", "Create all 33 synthesis items.") },
    { world: L("Blade Master", "Blade Master"), what: L("Bronze", "Bronze"), where: L("Obtenir toutes les Keyblades.", "Obtain all Keyblades.") },
    { world: L("Master Magician", "Master Magician"), what: L("Bronze", "Bronze"), where: L("Obtenir toutes les armes de Donald.", "Obtain all of Donald's weapons.") },
    { world: L("Master Defender", "Master Defender"), what: L("Bronze", "Bronze"), where: L("Obtenir toutes les armes de Dingo.", "Obtain all of Goofy's weapons.") },
    { world: L("Level Master", "Level Master"), what: L("Argent", "Silver"), where: L("Atteindre le niveau 100 avec Sora.", "Reach level 100 with Sora.") },
        ],
      },
      {
        id: "journal",
        ...
        columns: [L("Trophée", "Trophy"), L("Type", "Type"), L("Comment l'obtenir", "How to get it")],
        rows: [
    { world: L("Storyteller", "Storyteller"), what: L("Bronze", "Bronze"), where: L("Compléter la section Chroniques du Journal de Jiminy.", "Collect all Story entries in Jiminy's Journal.") },
    { world: L("Searcher", "Searcher"), what: L("Bronze", "Bronze"), where: L("Réunir tous les rapports d'Ansem.", "Collect all Ansem's Reports.") },
    { world: L("Professor", "Professor"), what: L("Bronze", "Bronze"), where: L("Compléter la section Personnages du Journal.", "Complete the Character section of the Journal.") },
    { world: L("Top Dog", "Top Dog"), what: L("Bronze", "Bronze"), where: L("Compléter les 99 fiches de dalmatiens.", "Complete all 99 puppies' entries.") },
    { world: L("Best Friend", "Best Friend"), what: L("Bronze", "Bronze"), where: L("Compléter la section des marques Trio.", "Complete the Trinity Marks section.") },
    { world: L("Mini-game Maniac", "Mini-game Maniac"), what: L("Bronze", "Bronze"), where: L("Compléter la section des mini-jeux.", "Complete the Minigames section.") },
    { world: L("Record Keeper", "Record Keeper"), what: L("Bronze", "Bronze"), where: L("Compléter entièrement le Journal de Jiminy.", "Complete every entry in Jiminy's Journal.") },
        ],
      },
      {
        id: "gummi",
        ...
        columns: [L("Trophée", "Trophy"), L("Type", "Type"), L("Comment l'obtenir", "How to get it")],
        rows: [
    { world: L("Customizer", "Customizer"), what: L("Bronze", "Bronze"), where: L("Personnaliser un vaisseau Gummi et améliorer ses statistiques.", "Customize a Gummi ship and improve its stats.") },
    { world: L("Test Pilot", "Test Pilot"), what: L("Bronze", "Bronze"), where: L("Réussir une mission Gummi de niveau 1.", "Complete a level 1 Gummi mission.") },
    { world: L("Veteran Pilot", "Veteran Pilot"), what: L("Bronze", "Bronze"), where: L("Réussir une mission Gummi de niveau 2.", "Complete a level 2 Gummi mission.") },
    { world: L("Ace Pilot", "Ace Pilot"), what: L("Bronze", "Bronze"), where: L("Réussir une mission Gummi de niveau 3.", "Complete a level 3 Gummi mission.") },
    { world: L("Flying Ace", "Flying Ace"), what: L("Bronze", "Bronze"), where: L("Détruire plus de 2 500 vaisseaux ennemis.", "Defeat over 2,500 enemy ships.") },
    { world: L("Top Gun", "Top Gun"), what: L("Bronze", "Bronze"), where: L("Terminer toutes les routes Gummi.", "Clear all Gummi routes.") },
    { world: L("Gummi Ship Collector", "Gummi Ship Collector"), what: L("Bronze", "Bronze"), where: L("Réunir tous les plans de vaisseau Gummi.", "Collect all Gummi ship blueprints.") },
        ],
      },
      {
        id: "parties",
        ...
        columns: [L("Trophée", "Trophy"), L("Type", "Type"), L("Comment l'obtenir", "How to get it")],
        rows: [
    { world: L("Novice Player", "Novice Player"), what: L("Bronze", "Bronze"), where: L("Terminer le jeu en Débutant.", "Clear the game on Beginner.") },
    { world: L("Final Mix Master", "Final Mix Master"), what: L("Argent", "Silver"), where: L("Terminer le jeu en Normal.", "Clear the game on Final Mix (Normal).") },
    { world: L("Proud Player", "Proud Player"), what: L("Or", "Gold"), where: L("Terminer le jeu en Expert et regarder la fin.", "Clear Proud mode and watch the ending.") },
    { world: L("Speedster", "Speedster"), what: L("Or", "Gold"), where: L("Battre le Monde du Chaos en moins de quinze heures de jeu.", "Defeat the World of Chaos in under fifteen hours of play.") },
    { world: L("Undefeated", "Undefeated"), what: L("Argent", "Silver"), where: L("Terminer le jeu sans utiliser une seule continuation.", "Clear the game without using continues.") },
    { world: L("Unchanging Armor", "Unchanging Armor"), what: L("Argent", "Silver"), where: L("Terminer le jeu sans jamais changer l'arme ni les accessoires de départ.", "Clear the game without ever changing the starting weapon or accessories.") },
    { world: L("KINGDOM HEARTS Master", "KINGDOM HEARTS Master"), what: L("Platine", "Platinum"), where: L("Obtenir tous les autres trophées.", "Obtain every other trophy.") },
        ],
      },
    ],
    rewards: {
      ...
      rows: [
        { tier: L("Bronze", "Bronze"), reward: L("41 trophées : la progression de l'histoire, les coupes, la collection et le Journal.", "41 trophies: story progress, the cups, collection and the Journal.") },
        { tier: L("Argent", "Silver"), reward: L("4 trophées : niveau 100, partie terminée en Normal, sans continuation, sans changer d'équipement.", "4 trophies: level 100, clearing on Normal, no continues, no equipment change.") },
        { tier: L("Or", "Gold"), reward: L("2 trophées : partie terminée en Expert, et le Monde du Chaos en moins de quinze heures.", "2 trophies: clearing on Proud, and the World of Chaos in under fifteen hours.") },
        { tier: L("Platine", "Platinum"), reward: L("KINGDOM HEARTS Master, une fois tous les autres obtenus.", "KINGDOM HEARTS Master, once every other trophy is earned.") },
      ],
      note: L(
        "Deux parties suffisent : une en Expert menée à la complétion, une en Débutant qui réunit Speedster, Undefeated et Unchanging Armor.",
