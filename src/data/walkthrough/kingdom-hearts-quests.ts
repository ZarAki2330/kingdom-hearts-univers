...
export const quests: WalkQuest[] = [
  ...
  },
  {
    ...
    steps: [
      {
        id: "bolet-blanc",
        image: { src: "/images/walkthrough/champignons.webp", credit: credit("White Mushroom (Art) KH.png"), width: 183, height: 320 },
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        intro: L(
          "Ils ne s'utilisent pas : ils s'accumulent au fil de l'histoire. Seuls les derniers de la liste se revendent.",
          "They are not used: they pile up as the story goes. Only the last ones on the list can be sold.",
        ),
        columns: [L("Objet", "Item"), L("À quoi il sert", "What it is for"), L("Où", "Where")],
        rows: [
          at("Rondin, Corde, Grand Drap", ["Construire le radeau du premier jour.", "Building the first day's raft."], ["Îles du Destin.", "Destiny Islands."]),
          at("Noix de coco, Champignon, Poisson, Œuf, Eau potable, Bouteille vide", ["Les provisions de la liste de Kairi.", "The provisions on Kairi's list."], ["Îles du Destin, deuxième jour.", "Destiny Islands, day two."]),
          at("Jolie Pierre", ["À revendre. Rien d'autre.", "To sell. Nothing else."], ["Îles du Destin, en battant Riku à la course ; Ville de Traverse.", "Destiny Islands, by beating Riku in a race; Traverse Town."]),
          at("Épine, Marque de griffe, Odeur, Trace de pas", ["Les quatre preuves du procès d'Alice.", "The four pieces of evidence at Alice's trial."], ["Pays des Merveilles.", "Wonderland."]),
          at("Billet d'entrée, Licence de héros", ["Participer aux tournois, puis prouver qu'on est un héros.", "Entering the tournaments, then proving you are a hero."], ["Colisée de l'Olympe.", "Olympus Coliseum."]),
          ...
          at("Vieux livre, Pages déchirées", ["Ouvrir la Forêt des Rêves Bleus, puis en restaurer les pages.", "Opening the Hundred Acre Wood, then restoring its pages."], ["Le livre chez Cid ; les cinq pages à la Ville de Traverse, Agrabah, Monstro, Atlantica et la Ville d'Halloween.", "The book at Cid's; the five pages in Traverse Town, Agrabah, Monstro, Atlantica and Halloween Town."]),
          at("Boîte à malices, Myosotis", ["Les deux commandes du docteur Finkelstein.", "Dr. Finkelstein's two errands."], ["Ville d'Halloween.", "Halloween Town."]),
          at("Cristal royal", ["Ouvrir le passage de la grotte d'Ariel.", "Opening the way in Ariel's Grotto."], ["Atlantica.", "Atlantica."]),
          at("Volumes Azal, Hafet, Khama, Mava, Nahara, Salegg, Theon", ["L'énigme de la bibliothèque, qui ouvre le passage caché.", "The library puzzle, which opens the hidden passage."], ["Forteresse Oubliée.", "Hollow Bastion."]),
          at("Morceaux d'emblème", ["Quatre à réunir pour ouvrir la porte du hall.", "Four to gather to open the hall's door."], ["Forteresse Oubliée.", "Hollow Bastion."]),
          at("Éclats de Terre, d'Eau, de Nature et de Feu", ["Les quatre pierres d'invocation, à porter à la Bonne Fée.", "The four summon gems, to take to the Fairy Godmother."], ["Ville de Traverse, Monstro, Forêt des Rêves Bleus, Forteresse Oubliée.", "Traverse Town, Monstro, the Hundred Acre Wood, Hollow Bastion."]),
          at("Fragments et Warp-G", ["Améliorer le vaisseau, puis sauter les trajets déjà faits.", "Upgrading the ship, then skipping flights already made."], ["De Cid, contre les fragments Navi-G rapportés des mondes.", "From Cid, in exchange for the Navi-G Pieces brought back from the worlds."]),
          at("Cartes postales", ["Dix à glisser dans la boîte du premier quartier.", "Ten to drop into the First District's mailbox."], ["Ville de Traverse. Voir la quête dédiée.", "Traverse Town. See the dedicated quest."]),
          at("Brevets", ["Les sept montrés à Merlin donnent la Targe des Rêves à Dingo.", "The seven shown to Merlin grant Goofy the Dream Shield."], ["Des Bolets Blancs, trois fois le même sort.", "From White Mushrooms, three casts of the same spell."]),
          at("Prix Shiitake, Prix Matsutake, Moisissure Mystère", ["À revendre, et à cocher au Journal. Rien de plus.", "To sell, and to tick off in the Journal. Nothing more."], ["Truffes Bleues et Fungus Noirs.", "Rare Truffles and Black Fungi."]),
        ],
      },
      {
        id: "gummi",
        ...
        intro: L(
          "Tout s'achète chez **Cid**, derrière la boutique d'accessoires, et la liste s'agrandit à mesure qu'on lui rapporte des fragments Navi-G. Les 99 dalmatiens en donnent aussi, par paliers.",
          "Everything is bought from **Cid**, behind the Accessory Shop, and the list grows as you bring him Navi-G Pieces. The 99 puppies also give some, in tiers.",
        ),
        columns: [L("Famille", "Family"), L("À quoi ça sert", "What it does"), L("À savoir", "Worth knowing")],
        rows: [
          at("Réacteurs (Brasier, Brasier+, Brasier X, Atomnium, Sidéral)", ["La puissance du vaisseau : vitesse et accélération.", "The ship's power: speed and acceleration."], ["Le premier achat utile. Sans réacteur correct, les trajets sont interminables.", "The first worthwhile purchase. Without a decent engine, the flights drag on."]),
          at("Blindages (Carapace, Blindage, Dissipation)", ["Réduisent les dégâts subis, de plus en plus.", "Cut the damage taken, increasingly so."], ["Huit niveaux chacun : montez-les avant de chercher la puissance de feu.", "Eight levels each: raise them before chasing firepower."]),
          at("Armes (Foudre, Comète, Météore, Ultima)", ["Canons et lasers.", "Cannons and lasers."], ["Les lasers traversent tout, mais coûtent cher en espace.", "Lasers go through everything, but cost a lot of space."]),
          at("Maniabilité (Rafale, Tornade, Lévitation)", ["La souplesse du pilotage.", "How nimble the ship handles."], ["Tornade est le meilleur des trois.", "Tornado is the best of the three."]),
          at("Soin et Vie", ["Récupération en vol, et relance si la jauge se vide.", "Recovery in flight, and a second wind if the gauge empties."], ["Le bloc Vie Max évite de refaire un trajet entier.", "The Max Life block saves you replaying a whole flight."]),
          at("Utilitaires (Aspire, Scan, Booster, Barrière, Esuna, Téléportation)", ["Attirer les objets, repérer les ennemis, accélérer, se protéger, voir l'invisible.", "Attract items, spot enemies, accelerate, shield, see the invisible."], ["Les blocs Aspire sont ceux qui changent le plus le confort : ils ramassent tout seuls.", "The suction blocks change the comfort most: they pick everything up for you."]),
          at("Atelier (Spray, Palette, Extensions, Ordinateurs)", ["Peindre, agrandir la zone d'assemblage, relever les capacités maximales.", "Painting, enlarging the build area, raising the maximum stats."], ["Le seul vraiment utile est **COM LVL2**, qui relève les plafonds.", "The only truly useful one is **COM LVL2**, which raises the caps."]),
        ],
      },
    ],
  },
  {
    ...
    tables: [
      {
        id: "familles",
        title: L("Les familles de Sans-cœur", "The Heartless families"),
        intro: L(
          "Kingdom Hearts n'a qu'une espèce d'ennemis, déclinée en deux variantes, plus une poignée de boss qui n'en sont pas.",
          "Kingdom Hearts has only one enemy species, in two variants, plus a handful of bosses that are not Heartless at all.",
        ),
        columns: [L("Famille", "Family"), L("Ce qui les distingue", "What sets them apart"), L("Exemples", "Examples")],
        rows: [
          at("Sans-cœur pur-sang", ["Nés naturellement des ténèbres d'un cœur. Pas d'emblème, une silhouette noire et des antennes.", "Born naturally from the darkness of a heart. No emblem, a black silhouette and antennae."], ["Ombres, Néo-Ombres, Boules Noires, Invincibles, Darkside.", "Shadows, Neoshadows, Darkballs, Invisibles, the Darkside."]),
          at("Sans-cœur emblèmes", ["Fabriqués par les machines d'Ansem. Ils portent l'emblème en forme de cœur barré.", "Manufactured by Ansem's machines. They wear the crossed-heart emblem."], ["Soldats, Bandits, Pirates, Défenseurs, Sorciers, les deux Armures.", "Soldiers, Bandits, Pirates, Defenders, Wizards, both Armors."]),
          at("Champignons", ["Des emblèmes à part : trois sur quatre ne se battent pas, ils se satisfont.", "Emblems apart: three of the four do not fight, they are satisfied."], ["Bolet Blanc, Truffe Bleue, Fungus Noir, Agaric Rose.", "White Mushroom, Rare Truffle, Black Fungus, Pink Agaricus."]),
          at("Les autres", ["Ni Sans-cœur ni emblèmes : des personnages et des créatures du monde visité.", "Neither Heartless nor Emblems: characters and creatures of the world you are visiting."], ["Cerbère, Sabor, Clayton, Jafar, Oogie Boogie, Hadès, les Titans, Séphiroth.", "Cerberus, Sabor, Clayton, Jafar, Oogie Boogie, Hades, the Titans, Sephiroth."]),
        ],
      },
      {
        id: "a-connaitre",
        collapsed: true,
        title: L("Les ennemis qui demandent une réponse précise", "The enemies that need a specific answer"),
        intro: L(
          "La plupart se battent normalement. Ceux-là non — et s'y prendre de travers coûte cher.",
          "Most are fought normally. These are not — and getting them wrong is costly.",
        ),
        columns: [L("Ennemi", "Enemy"), L("Le problème", "The problem"), L("La réponse", "The answer")],
        rows: [
          at("Requiem Vert", ["Inoffensif seul, mais il **soigne les autres Sans-cœur** et absorbe tous les éléments sauf la Gravité.", "Harmless alone, but it **heals other Heartless** and absorbs every element except Gravity."], ["Le tuer en premier, systématiquement.", "Kill it first, every time."]),
          at("Défenseur", ["Son bouclier bloque **tous** les dégâts de face.", "Its shield blocks **all** frontal damage."], ["Le contourner, ou l'étourdir. La Gravité passe.", "Go around it, or stun it. Gravity gets through."]),
          at("Sorcier", ["Absorbe tous les sorts sauf Gravité et Stop, et se téléporte.", "Absorbs every spell but Gravity and Stop, and teleports."], ["Gravité, Stop, puis le corps à corps pendant qu'il est figé.", "Gravity, Stop, then melee while it is frozen."]),
          at("Gargouille", ["Se change en volute d'énergie **invulnérable** et vous suit.", "Turns into an **invulnerable** wisp of energy and follows you."], ["Attendre qu'elle se reforme plutôt que de perdre des coups.", "Wait for it to reform rather than waste swings."]),
          at("Arachnocruche et Arachnobaril", ["Déguisées en décor, et l'une explose.", "Disguised as scenery, and one of them explodes."], ["Ne pas casser les jarres et les tonneaux à l'aveugle.", "Do not smash jars and barrels blindly."]),
          at("Soldat Furtif", ["Invisible. Exclusif à Final Mix.", "Invisible. Final Mix only."], ["Le verrouillage le trouve. Stop le règle.", "Lock-on finds it. Stop settles it."]),
          at("Invisible", ["Beaucoup de vie, gros dégâts, et un anneau de flammes autour de vous.", "High HP, heavy damage, and a ring of flame around you."], ["Sauter **au moment où l'anneau se resserre**.", "Jump **as the ring contracts**."]),
          at("Étoile Angélique", ["Bloque les attaques de face avec ses ailes et **absorbe la Foudre**.", "Blocks frontal attacks with its wings and **absorbs Thunder**."], ["La frapper quand elle brille : cela interrompt son attaque spéciale.", "Hit it when it glows: that interrupts its special move."]),
          at("Béhémoth et Arche-Béhémoth", ["Énormes, et presque insensibles partout.", "Enormous, and nearly impervious everywhere."], ["La corne est le seul point faible. Le Saut Haut permet de monter sur le dos.", "The horn is the only weak point. High Jump gets you onto its back."]),
        ],
      },
    ],
  },
