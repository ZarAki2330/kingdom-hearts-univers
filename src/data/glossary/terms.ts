...
export const terms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    term: L("Cimetière des Keyblades", "Keyblade Graveyard"),
  ...
  },
  {
    ...
    text: L(
      "La Guerre des Keyblades est la catastrophe d’origine. À l’Âge des Fées, cinq Unions de Porteurs, chacune dirigée par un Prophète, se soupçonnent mutuellement de trahison ; la méfiance orchestrée dégénère en bataille rangée au Cimetière des Keyblades, où presque tous les combattants meurent.\n\nLes conséquences sont irréversibles : la χ-blade est brisée en vingt fragments, Kingdom Hearts devient inaccessible, et le monde unique éclate en mondes séparés par des murs. Ce que la saga répète, c’est que cette guerre n’est jamais close. Xehanort veut délibérément la rejouer pour recréer la χ-blade, ce qu’il obtient dans Kingdom Hearts III ; le Cimetière des Keyblades sert alors deux fois de champ de bataille, à des siècles d’écart. La guerre n’est donc pas un souvenir mais un moule dans lequel chaque génération de personnages retombe.",
