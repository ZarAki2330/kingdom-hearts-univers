...
export const eras: Era[] = [
  ...
  },
  {
    ...
    summary: L(
      "Sept gardiens et treize ténèbres se rejoignent au Cimetière des Keyblades pour l’affrontement que le Maître Xehanort prépare depuis soixante ans.",
...
export const events: StoryEvent[] = [
  ...
  },
  {
    ...
    text: L(
      "Un sixième apprenti reçoit une mission différente des autres. Luxu se voit remettre la Keyblade Sans-Nom, celle qui contient l’œil du Maître, ainsi qu’une boîte noire qu’il ne doit jamais ouvrir. Sa consigne tient en peu de mots : traverser les siècles, transmettre l’arme et la boîte de porteur en porteur, et se placer là où l’histoire se joue sans jamais intervenir.\n\nPour tenir cette charge, Luxu passe d’un corps à l’autre au fil des générations. C’est le fil le plus long de la série : il relie l’Âge des Fées à Scala ad Caelum, puis à l’Organisation XIII, et il n’est révélé qu’au terme de Kingdom Hearts III.",
  ...
  // ─── Le monde reconstruit ─────────────────────────────────────────
  {
    ...
    text: L(
      "Les Dandelions se réveillent dans une Daybreak Town intacte, alors que le monde a été détruit. Les jours s’y ressemblent trop, certains détails ne changent jamais, et Ephemer et Skuld finissent par obtenir la réponse : cette ville est une reconstitution, un monde de données bâti sur les souvenirs de celle qui a disparu, et ils en sont eux-mêmes des copies.\n\nLeurs corps réels dorment ailleurs, à l’abri. Le dispositif n’est pas une prison mais un sas, destiné à conserver quelque chose le temps que l’extérieur se stabilise. Reste à décider si l’on peut annoncer à des survivants qu’ils ne sont pas ceux qui ont survécu.",
  ...
  // ─── La génération de la Contrée du Départ ────────────────────────
  {
    ...
    text: L(
      "Le Maître Xehanort a besoin de la χ-blade, l’arme originelle dont les Keyblades ordinaires ne sont que des imitations, et il a compris qu’elle naît du choc entre une lumière et une ténèbre pures. Il prend Ventus pour apprenti et tente de le faire tomber dans les ténèbres au Cimetière des Keyblades.\n\nL’enfant résiste, alors le vieil homme force : il fend son cœur en deux. La part sombre extraite prend un corps et un nom, Vanitas, et devient l’autre moitié de l’équation. Ce qui reste de Ventus est une coquille silencieuse que Xehanort abandonne, persuadé de l’avoir détruite pour rien.",
  ...
  },
  {
    ...
    era: "departure-generation",
    title: L("Le Cimetière des Keyblades et la χ-blade brisée", "The Keyblade Graveyard and the shattered χ-blade"),
    text: L(
  ...
  },
  {
    id: "demon-tide",
    era: "last-keyblade-war",
    title: L("Le Cimetière des Keyblades et la Marée Démoniaque", "The Keyblade Graveyard and the Demon Tide"),
    text: L(
