...
await p.goto('http://127.0.0.1:3020/fr/encyclopedie/personnages/aladdin', { waitUntil: 'networkidle' });
await p.screenshot({ path: '/tmp/kinds-fiche.png', clip: { x: 0, y: 60, width: 1200, height: 420 } });
await p.goto('http://127.0.0.1:3020/fr/encyclopedie/ennemis', { waitUntil: 'networkidle' });
