...
const P='http://localhost:3321';
for (const [path,file] of [['/soluces/kingdom-hearts/plongee-au-coeur','ch1'],['/soluces/kingdom-hearts/iles-du-destin','ch2'],['/soluces/kingdom-hearts','jeu']]) {
...
await m.goto(P+'/soluces/kingdom-hearts/plongee-au-coeur',{waitUntil:'networkidle'});
